      ...
      char *argv[])
{
  ...
  if(optind >= argc)
  {
    ltv_message("No output name specified, available outputs are:");
  ...
  ltv_message("Setting output to %s",argv[optind]);
  v4l2_set_output_by_name (videofd, argv[optind]);
