...
static const dvp_v4l2_video_mode_line_t DvpModeParamsTable[] = {
	 ...
	 * SD/ED modes 
	 */
	{DVP_720_480_I60000, {60000, STM_INTERLACED_SCAN, 720, 480, 119, 36},
	 {false, false}},
	{DVP_720_480_P60000, {60000, STM_PROGRESSIVE_SCAN, 720, 480, 122, 36},
	 {false, false}},
	{DVP_720_480_I59940, {59940, STM_INTERLACED_SCAN, 720, 480, 119, 36},
	 {false, false}},
	{DVP_720_480_P59940, {59940, STM_PROGRESSIVE_SCAN, 720, 480, 122, 36},
	 {false, false}},
	{DVP_640_480_I59940, {59940, STM_INTERLACED_SCAN, 640, 480, 118, 38},
	 {false, false}},
	{DVP_720_576_I50000, {50000, STM_INTERLACED_SCAN, 720, 576, 132, 44},
	 {false, false}},
	{DVP_720_576_P50000, {50000, STM_PROGRESSIVE_SCAN, 720, 576, 132, 44},
	 {false, false}},
	{DVP_768_576_I50000, {50000, STM_INTERLACED_SCAN, 768, 576, 155, 44},
	 {false, false}},

	/*
	 * Modes used in VCR trick modes
	 */
	{DVP_720_240_P59940, {59940, STM_PROGRESSIVE_SCAN, 720, 240, 119, 18},
	 {false, false}},
	{DVP_720_240_P60000, {60000, STM_PROGRESSIVE_SCAN, 720, 240, 119, 18},
	 {false, false}},
	{DVP_720_288_P50000, {50000, STM_PROGRESSIVE_SCAN, 720, 288, 132, 22},
	 {false, false}},

	/*
	 * 1080p modes, SMPTE 274M (analogue) and CEA-861-C (HDMI)
	 */
	{DVP_1920_1080_P60000,
	 {60000, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P59940,
	 {59940, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P50000,
	 {50000, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P30000,
	 {30000, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P29970,
	 {29970, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P25000,
	 {25000, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P24000,
	 {24000, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},
	{DVP_1920_1080_P23976,
	 {23976, STM_PROGRESSIVE_SCAN, 1920, 1080, 192, 41}, {true, true}},

	/*
	 * 1080i modes, SMPTE 274M (analogue) and CEA-861-C (HDMI)
	 */
	{DVP_1920_1080_I60000,
	 {60000, STM_INTERLACED_SCAN, 1920, 1080, 192, 40}, {true, true}},
	{DVP_1920_1080_I59940,
	 {59940, STM_INTERLACED_SCAN, 1920, 1080, 192, 40}, {true, true}},
	{DVP_1920_1080_I50000_274M,
	 {50000, STM_INTERLACED_SCAN, 1920, 1080, 192, 40}, {true, true}},
	/* Australian 1080i. */
	{DVP_1920_1080_I50000_AS4933,
	 {50000, STM_INTERLACED_SCAN, 1920, 1080, 352, 124}, {true, true}},

	/*
	 * 720p modes, SMPTE 296M (analogue) and CEA-861-C (HDMI)
	 */
	{DVP_1280_720_P60000, {60000, STM_PROGRESSIVE_SCAN, 1280, 720, 260, 25},
	 {true, true}},
	{DVP_1280_720_P59940, {59940, STM_PROGRESSIVE_SCAN, 1280, 720, 260, 25},
	 {true, true}},
	{DVP_1280_720_P50000, {50000, STM_PROGRESSIVE_SCAN, 1280, 720, 260, 25},
	 {true, true}},

	/*
	 * A 1280x1152@50Hz Australian analogue HD mode.
	 */
	{DVP_1280_1152_I50000,
	 {50000, STM_INTERLACED_SCAN, 1280, 1152, 235, 178}, {true, true}},
	 ...
	 */
	{DVP_640_480_P59940, {59940, STM_PROGRESSIVE_SCAN, 640, 480, 144, 35},
	 {false, false}},
	{DVP_640_480_P60000, {60000, STM_PROGRESSIVE_SCAN, 640, 480, 144, 35},
	 {false, false}}
};
...
static dvp_v4l2_video_handle_t *DvpVideoSysfsLookupContext(struct device
							   *class_dev)
{
...
static ssize_t DvpVideoSysfsShow##DvpName( struct device *class_dev, struct device_attribute *attr, char *buf ) \
{                                                                                               \
    int v = atomic_read(&DvpVideoSysfsLookupContext(class_dev)->Dvp##DvpName);                  \
    return sprintf(buf, "%d\n", v);                                                             \
}                                                                                               \
												\
static ssize_t DvpVideoSysfsStore##DvpName( struct device *class_dev, struct device_attribute *attr, const char *buf, size_t count )    \
{                                                                                               \
    int v;                                                                                      \
												\
    if (1 != sscanf(buf, "%i", &v))                                                             \
    ...
    return count;                                                                               \
												...
												\
static DEVICE_ATTR(LinuxName, 0600, DvpVideoSysfsShow##DvpName, DvpVideoSysfsStore##DvpName)
// ------------------------------------------------------------------------------------------------
#define SYSFS_CREATE( DvpName, LinuxName )                                                      \
{                                                                                               \
int Result;                                                                                     \
												\
    Result  = device_create_file(VideoContext->DvpSysfsClassDevice,                       \
				      &dev_attr_##LinuxName);                          \
    if (Result) {                                                                               \
...
SYSFS_DECLARE_WITH_INTERRUPT_DECREMENT(FrameCountingNotification,
				       frame_counting_notification);
SYSFS_DECLARE_WITH_INTERRUPT_DECREMENT(FrameCaptureNotification,
				       frame_capture_notification);
SYSFS_DECLARE_WITH_PROCESS_DECREMENT(OutputCropTargetReachedNotification,
				     output_crop_target_reached_notification);
...
static int DvpVideoSysfsCreateAttributes(dvp_v4l2_video_handle_t * VideoContext)
{
	...
	Result =
	    DvbStreamGetPlayerEnvironment(VideoContext->
	...
	VideoContext->DvpSysfsClassDevice =
	    player_sysfs_get_class_device(playerplayback, playerstream);
	if (VideoContext->DvpSysfsClassDevice == NULL) {
		DVB_ERROR("get_device failed -> cannot create attribute \n");
		return -1;
	}

	streamid =
	    player_sysfs_get_stream_id(VideoContext->DvpSysfsClassDevice);
...
//
	...
	SYSFS_CREATE(OutputCropTargetReachedNotification,
		     output_crop_target_reached_notification);
...
//
	...
	if (Context->VideoRunning) {
		...
		OSDEV_IOUnMap((unsigned int)
			      Context->AncillaryInputBufferUnCachedAddress);
		OSDEV_FreePartitioned(DVP_ANCILLARY_PARTITION,
				      Context->AncillaryInputBufferPhysicalAddress);

		Result =
		    DvbDisplayDelete(STM_SE_MEDIA_VIDEO,
				     Context->DeviceContext->Id);
		if (Result) {
			printk("Error in %s: DvbDisplayDelete failed\n",
			       __FUNCTION__);
			return -EINVAL;
		}
...
static int DvpConfigureVerticalResizeCoefficients(dvp_v4l2_video_handle_t *
						  Context,
						  unsigned int
						  ScalingFactorStep)
{
	...
	for (Index = 0;
	     (ScalingFactorStep >
	      VerticalResizingFilters[Index].ForScalingFactorLessThan);
	     Index++) ;
...
static int DvpConfigureHorizontalResizeCoefficients(dvp_v4l2_video_handle_t *
						    Context,
						    unsigned int
						    ScalingFactorStep)
{
	...
	for (Index = 0;
	     (ScalingFactorStep >
	      HorizontalResizingFilters[Index].ForScalingFactorLessThan);
	     Index++) ;
...
//
	...
	ScalingInputWidth =
	    (Context->ScaledInputCrop.Width !=
	     0) ? Context->ScaledInputCrop.Width : Context->ModeWidth;
	ScalingInputHeight =
	    (Context->ScaledInputCrop.Height !=
	     0) ? Context->ScaledInputCrop.Height : Context->ModeHeight;
	ScalingOutputWidth =
	    (Context->OutputCrop.Width !=
	     0) ? Context->OutputCrop.Width : Context->ModeWidth;
	ScalingOutputHeight =
	    (Context->OutputCrop.Height !=
	     0) ? Context->OutputCrop.Height : Context->ModeHeight;
	...
	if (ControlValue(HorizontalResizeEnable) &&
		...
		NewHSRC =
		    0x01000000 | (((ScalingInputWidth - 1) * 256) /
				  (ScalingOutputWidth - 1));

		Context->ScaledInputCrop.X =
		    ((Context->ScaledInputCrop.X * ScalingOutputWidth) /
		     ScalingInputWidth);
		Context->ScaledInputCrop.Width =
		    ((Context->ScaledInputCrop.Width * ScalingOutputWidth) /
		     ScalingInputWidth);

		ScaledInputWidth =
		    ((Context->ModeWidth * ScalingOutputWidth) /
		     ScalingInputWidth);
	}
//
	...
	if (ControlValue(VerticalResizeEnable) &&
		...
		NewVSRC =
		    0x01000000 | (((ScalingInputHeight - 1) * 256) /
				  (ScalingOutputHeight - 1));

		Context->ScaledInputCrop.Y =
		    ((Context->ScaledInputCrop.Y * ScalingOutputHeight) /
		     ScalingInputHeight);
		Context->ScaledInputCrop.Height =
		    ((Context->ScaledInputCrop.Height * ScalingOutputHeight) /
		     ScalingInputHeight);

		ScaledInputHeight =
		    ((Context->ModeHeight * ScalingOutputHeight) /
		     ScalingInputHeight);
	}
	//
	...
	// requires a 64 byte (32 pixel) alignment on a line.
	//

	BytesPerLine =
	    Context->BufferBytesPerPixel *
	    ((ScaledInputWidth + 31) & 0xffffffe0);

	Context->NextWidth = ScaledInputWidth;
	Context->NextHeight = ScaledInputHeight;
	Context->NextRegisterCVS =
	    ScaledInputWidth |
	    ((ScaledInputHeight /
	      (Context->StreamInfo.interlaced ? 2 : 1)) << 16);;
	Context->NextRegisterVMP =
	    BytesPerLine * (Context->StreamInfo.interlaced ? 2 : 1);
	Context->NextRegisterVBPminusVTP =
	    (Context->StreamInfo.interlaced ? BytesPerLine : 0);
...
//
	...
	Record =
	    &Context->DvpBufferStack[Context->DvpNextBufferToGet %
				     DVP_VIDEO_DECODE_BUFFER_STACK_SIZE];
...
//
	...
	Result = DvbStreamGetDecodeBuffer(Context->DeviceContext->VideoStream,
					  ...
					  SurfaceFormat,
					  2, Dimensions,
					  &BufferIndex, &Context->BytesPerLine);

	if (Result != 0) {
		printk("Error in %s: DvbStreamGetDecodeBuffer failed\n",
		       __FUNCTION__);
		return -1;
	}

	if (Context->BytesPerLine !=
	    (Dimensions[0] * Context->BufferBytesPerPixel)) {
		printk
		    ("Error in %s: DvbStreamGetDecodeBuffer returned an unexpected bytes per line value (%d instead of %d)\n",
		     __FUNCTION__, Context->BytesPerLine,
		     (Dimensions[0] * Context->BufferBytesPerPixel));
	}
//
...
//
	...
	while (Context->DvpNextBufferToInject < Context->DvpNextBufferToGet) {
		Record =
		    &Context->DvpBufferStack[Context->DvpNextBufferToInject %
					     DVP_VIDEO_DECODE_BUFFER_STACK_SIZE];

		Result =
		    DvbStreamReturnDecodeBuffer(Context->
						DeviceContext->VideoStream,
						Record->Buffer);
		if (Result < 0) {
			printk
			    ("Error in %s: DvbStreamReturnDecodeBuffer failed\n",
			     __FUNCTION__);
...
//
	...
	Pts =
	    (((Context->DvpBaseTime * 27) + 150) / 300) & 0x00000001ffffffffull;

	Result =
	    avr_set_external_time_mapping(Context->SharedContext,
					  Context->DeviceContext->VideoStream,
					  Pts, Context->DvpBaseTime);
	if (Result < 0) {
		printk
		    ("DvpInjectVideoBuffer - dvp_enable_external_time_mapping failed\n");
		return Result;
	}
//
	...
	ElapsedFrameTime =
	    DvpCorrectedTimeForNFrames(Context->DvpFrameCount +
				       Context->DvpLeadInVideoFrames);

	Context->DvpDriftFrameCount++;
	Context->DvpLastDriftCorrection =
	    -(Context->DvpCurrentDriftError * Context->DvpDriftFrameCount) /
	    (long long)(2 * DVP_MAXIMUM_TIME_INTEGRATION_FRAMES);

	Record->ExpectedFillTime =
	    Context->DvpBaseTime + ElapsedFrameTime +
	    Context->DvpLastDriftCorrection;
	...
	Packet.pixel_aspect_ratio.Numerator =
	    Context->DeviceContext->PixelAspectRatio.Numerator;
	Packet.pixel_aspect_ratio.Denominator =
	    Context->DeviceContext->PixelAspectRatio.Denominator;
...
//printk( "ElapsedFrameTime = %12lld - %016llx - %12lld, %12lld - %016llx\n", ElapsedFrameTime, Pts, StreamInfo.FrameRateNumerator, StreamInfo.FrameRateDenominator, DvpFrameDurationCorrection );
	...
	Result =
	    DvbStreamInjectPacket(Context->DeviceContext->VideoStream,
				  (const unsigned char *)(&Packet),
				  sizeof(StreamInfo_t), true, Pts);
	if (Result < 0) {
	...
	Result =
	    DvbStreamReturnDecodeBuffer(Context->DeviceContext->VideoStream,
					Record->Buffer);
	if (Result < 0) {
					 ...
					 unsigned long long Now)
{
	...
	DroppedAFrame = false;
	Record =
	    &Context->DvpBufferStack[Context->DvpNextBufferToFill %
				     DVP_VIDEO_DECODE_BUFFER_STACK_SIZE];
...
//      printk( "DVP Video - No buffer to move onto - We dropped a frame (%d, %d) %d\n", Context->DvpNextBufferToFill, Context->DvpNextBufferToGet, Context->DvpPreInjectBufferSem.count );
	    ...
	    if (inrange
		((Now - Record->ExpectedFillTime),
		 ((7 * DvpTimeForNFrames(1)) / 8), 0x8000000000000000ULL)) {
		...
		printk
		    ("DVP Video - Too early to fill buffer(%d), Discarding a frame (%lld)\n",
		     Context->DvpNextBufferToFill,
		     (Record->ExpectedFillTime - Now));
		DroppedAFrame = true;
	}

	Context->DvpMissedFramesInARow =
	    DroppedAFrame ? (Context->DvpMissedFramesInARow + 1) : 0;
	...
	if (!DroppedAFrame
	    && inrange((Now - Record->ExpectedFillTime), DvpTimeForNFrames(1),
		       0x8000000000000000ULL)) {
		ShouldSkip =
		    ((Now - Record->ExpectedFillTime) +
		     (DvpTimeForNFrames(1) / 8) - 1) / DvpTimeForNFrames(1);

		printk
		    ("DVP Video - Too late to fill buffer(%d), should have skipped %lld buffers (Late by %lld)\n",
		     Context->DvpNextBufferToFill, ShouldSkip,
		     (Now - Record->ExpectedFillTime));
		...
		for (i = Context->DvpNextBufferToFill;
		     i < Context->DvpNextBufferToGet; i++)
			Context->DvpBufferStack[i %
						DVP_VIDEO_DECODE_BUFFER_STACK_SIZE].ExpectedFillTime
			    += ShouldSkip;
	}
	//
	...
	if (Record->RegisterHSRC != Context->LastRegisterHSRC) {
		...
		if (Record->RegisterHSRC != DVP_SRC_OFF_VALUE) {
			DvpConfigureHorizontalResizeCoefficients(Context,
								 (Record->RegisterHSRC
								  &
								  0x00000fff));
...
//
	...
	if (Record->RegisterVSRC != Context->LastRegisterVSRC) {
		...
		if (Record->RegisterVSRC != DVP_SRC_OFF_VALUE) {
			DvpConfigureVerticalResizeCoefficients(Context,
							       (Record->RegisterVSRC
								& 0x00000fff));
	...
	DvpRegs[GAM_DVP_VTP] =
	    (unsigned int)Record->Data + 128 + (64 * Record->RegisterVMP);
	DvpRegs[GAM_DVP_VBP] =
	    (unsigned int)Record->Data + 128 + (64 * Record->RegisterVMP) +
	    Record->RegisterVBPminusVTP;
	capture_address =
	    (unsigned int)Record->Data + 128 + (64 * Record->RegisterVMP);
#else
...
static int DvpHaltCapture(dvp_v4l2_video_handle_t * Context)
{
	...
	DvpRegs[GAM_DVP_CTL] = DvpRegs[GAM_DVP_CTL] | 0x80080000;
	DvpRegs[GAM_DVP_ITM] = 0x00;
	Tmp = DvpRegs[GAM_DVP_ITS];

	OSDEV_SleepMilliSeconds(50);
...
//
	...
	Context->DvpControlDefaultOddPixelCount =
	    ((ModeParams->ActiveAreaWidth +
	      ControlValue(ActiveAreaAdjustWidth)) & 1);
	Context->DvpControlDefaultExternalVRefPolarityPositive =
	    TimingParams->VSyncPolarity;
	Context->DvpControlDefaultHRefPolarityPositive =
	    TimingParams->HSyncPolarity;
	...
	if (ModeParams->ScanType == STM_INTERLACED_SCAN)
		Context->StreamInfo.FrameRateNumerator /= 2;

	DvpVideoSysfsInterruptSetMicroSecondsPerFrame(Context,
						      DvpTimeForNFrames(1));
...
//
	...
	Context->DvpBuffersRequiredToInjectAhead =
	    DVP_MAXIMUM_PLAYER_TRANSIT_TIME / DvpTimeForNFrames(1) + 1;
	...
	Context->ModeWidth =
	    ModeParams->ActiveAreaWidth + ControlValue(ActiveAreaAdjustWidth);
	Context->ModeHeight =
	    ModeParams->ActiveAreaHeight + ControlValue(ActiveAreaAdjustHeight);

	Context->StreamInfo.interlaced =
	    ModeParams->ScanType == STM_INTERLACED_SCAN;
	...
	Context->AppliedLatency =
	    ControlValue(VideoLatency) - Context->DvpLatency;

	DvbStreamSetOption(Context->DeviceContext->VideoStream,
			   DVB_OPTION_EXTERNAL_TIME_MAPPING_VSYNC_LOCKED,
			   Context->SynchronizeEnabled ? DVB_OPTION_VALUE_ENABLE
	...
	SixteenBit = ControlValue(16 Bit);

	HOffset =
	    ModeParams->ActiveAreaXStart +
	    ControlValue(ActiveAreaAdjustHorizontalOffset);
	Width =
	    ModeParams->ActiveAreaWidth + ControlValue(ActiveAreaAdjustWidth);
	VOffset =
	    ModeParams->FullVBIHeight +
	    ControlValue(ActiveAreaAdjustVerticalOffset);
	Height =
	    ModeParams->ActiveAreaHeight + ControlValue(ActiveAreaAdjustHeight);
...
// NAUGHTY - Since we are offseting the image, we need to crop it, or it will write past the buffer end
...
#if 0
	TopVoffset =
	    Context->StreamInfo.interlaced ? ((VOffset + 1) / 2) : VOffset;
	BottomVoffset =
	    Context->StreamInfo.interlaced ? (VOffset / 2) : VOffset;
#else
...
#endif
	TopHeight =
	    Context->StreamInfo.interlaced ? ((Height + 1) / 2) : Height;
	BottomHeight = Context->StreamInfo.interlaced ? (Height / 2) : Height;

	Context->RegisterTFO =
	    ((HOffset * (SixteenBit ? 1 : 2)) | (TopVoffset << 16));
	Context->RegisterTFS =
	    (((Width - 1) * (SixteenBit ? 1 : 2)) | ((TopHeight - 1) << 16)) +
	    Context->RegisterTFO;
	Context->RegisterBFO =
	    ((HOffset * (SixteenBit ? 1 : 2)) | (BottomVoffset << 16));
	Context->RegisterBFS =
	    (((Width - 1) * (SixteenBit ? 1 : 2)) | ((BottomHeight -
						      1) << 16)) +
	    Context->RegisterBFO;
	...
	Context->RegisterCTL = (ControlValue(16 Bit) << 30) |	// HD_EN                - 16 bit capture
...
//
	...
	Context->AncillaryInputBufferInputPointer =
	    Context->AncillaryInputBufferUnCachedAddress;
	memset(Context->AncillaryInputBufferUnCachedAddress, 0x00,
	       Context->AncillaryInputBufferSize);

	Context->AncillaryPageSizeSpecified =
	    ControlValue(AncPageSizeSpecified);
...
//
	...
	DvpRegs[GAM_DVP_ABA] =
	    (unsigned int)Context->AncillaryInputBufferPhysicalAddress;
...
//
	...
	printk
	    ("%08x %08x %08x %08x - %08x %08x %08x %08x - %08x %08x %08x %08x - %08x %08x\n",
	     DvpRegs[GAM_DVP_TFO], DvpRegs[GAM_DVP_TFS], DvpRegs[GAM_DVP_BFO],
	     DvpRegs[GAM_DVP_BFS], DvpRegs[GAM_DVP_VTP], DvpRegs[GAM_DVP_VBP],
	     DvpRegs[GAM_DVP_VMP], DvpRegs[GAM_DVP_CVS], DvpRegs[GAM_DVP_VSD],
	     DvpRegs[GAM_DVP_HSD], DvpRegs[GAM_DVP_HLL], DvpRegs[GAM_DVP_HSRC],
...
static int DvpStartup(dvp_v4l2_video_handle_t * Context)
{
	...
	sema_init(&Context->DvpPreInjectBufferSem,
		  Context->DvpBuffersRequiredToInjectAhead - 1);
...
//
	...
	while ((Context->DvpState != DvpStarted) && Context->VideoRunning
	       && !Context->FastModeSwitch)
...
static int DvpFrameRate(dvp_v4l2_video_handle_t * Context,
			unsigned long long MicroSeconds, unsigned int Frames)
{
	unsigned int i;
...
//
	...
	if (Context->StandardFrameRate)
		printk("DvpFrameRate - Framerate = %lld/%lld (%s)\n",
		       Context->StreamInfo.FrameRateNumerator,
		       Context->StreamInfo.FrameRateDenominator,
		       (Context->
			StreamInfo.interlaced ? "Interlaced" : "Progressive"));
	...
	NewDvpBuffersRequiredToInjectAhead =
	    DVP_MAXIMUM_PLAYER_TRANSIT_TIME / DvpTimeForNFrames(1) + 1;

	if (NewDvpBuffersRequiredToInjectAhead >
	    Context->DvpBuffersRequiredToInjectAhead) {
		for (i = Context->DvpBuffersRequiredToInjectAhead;
		     i < NewDvpBuffersRequiredToInjectAhead; i++)
			up(&Context->DvpPreInjectBufferSem);
...
//
	...
	if (Context->AncillaryCaptureInProgress) {
		...
		while (Context->AncillaryInputBufferInputPointer[0]) {
			...
			if ((Context->AncillaryInputBufferInputPointer -
			     Context->AncillaryInputBufferUnCachedAddress) >=
			    Context->AncillaryInputBufferSize)
				Context->AncillaryInputBufferInputPointer -=
				    Context->AncillaryInputBufferSize;
		...
		if (Context->AncillaryInputBufferInputPointer < Capturestart) {
			Transfer0 =
			    (Context->AncillaryInputBufferUnCachedAddress +
			     Context->AncillaryInputBufferSize) - Capturestart;
			Transfer1 =
			    Context->AncillaryInputBufferInputPointer -
			    Context->AncillaryInputBufferUnCachedAddress;
		} else {
	...
	if ((Transfer0 + Transfer1) > 0) {
		...
		if (Context->AncillaryStreamOn) {
			if (Context->AncillaryBufferNextFillIndex ==
			    Context->AncillaryBufferNextQueueIndex) {
				// printk( "DvpAncillaryCaptureInterrupt - No buffer queued to capture into.\n" );
			} else if ((Transfer0 + Transfer1) >
				   Context->AncillaryBufferSize) {
				printk
				    ("DvpAncillaryCaptureInterrupt - Captured data too large for buffer (%d bytes), discarded.\n",
				     (Transfer0 + Transfer1));
			} else {
				Index =
				    Context->
				    AncillaryBufferQueue
				    [Context->AncillaryBufferNextFillIndex %
				     DVP_MAX_ANCILLARY_BUFFERS];
				Context->AncillaryBufferState[Index].Queued =
				    false;
				Context->AncillaryBufferState[Index].Done =
				    true;
				Context->AncillaryBufferState[Index].Bytes =
				    (Transfer0 + Transfer1);
				Context->AncillaryBufferState[Index].FillTime =
				    Context->
				    DvpBufferStack[Context->DvpNextBufferToFill
						   %
						   DVP_VIDEO_DECODE_BUFFER_STACK_SIZE].ExpectedFillTime;

				memcpy(Context->
				       AncillaryBufferState
				       [Index].UnCachedAddress, Capturestart,
				       Transfer0);
				if (Transfer1 != 0)
					memcpy(Context->AncillaryBufferState
					       [Index].UnCachedAddress +
					       Transfer0,
					       Context->AncillaryInputBufferUnCachedAddress,
					       Transfer1);
		...
		if (Transfer1 != 0)
			memset(Context->AncillaryInputBufferUnCachedAddress,
			       0x00, Transfer1);
	}
	//
	...
	if (Context->AncillaryCaptureInProgress !=
	    AncillaryCaptureWasInProgress) {
		Context->RegisterCTL = Context->RegisterCTL | (Context->AncillaryPageSizeSpecified << 13) |	// VALID_ANC_PAGE_SIZE_EXT - During ANC (VBI) collection size will be specified in APS register
...
//printk( "DvpInterrupt - %d, %08x, %016llx - %lld, %d\n", Context->DvpState, DvpIts, Now, DvpTimeForNFrames(1), Context->DvpInterruptFrameCount );
	...
	case DvpInactive:
		printk
		    ("DvpInterrupt - Dvp inactive - possible implementation error.\n");
//                      DvpHaltCapture( Context );                              // Try and halt it
	...
	case DvpWarmingUp:
		EstimatedBaseTime =
		    Now -
		    DvpCorrectedTimeForNFrames(Context->DvpInterruptFrameCount);
		EstimatedBaseTimeRange =
		    1 +
		    (DvpTimeForNFrames(Context->DvpInterruptFrameCount) *
		     DVP_MAX_SUPPORTED_PPM_CLOCK_ERROR) / 1000000;

		if (!inrange
		    (Context->DvpBaseTime,
		     (EstimatedBaseTime - EstimatedBaseTimeRange),
		     (EstimatedBaseTime + EstimatedBaseTimeRange))
...
//                          printk( "DvpInterrupt - Base adjustment %4lld(%5lld) (%016llx[%d] - %016llx)\n", EstimatedBaseTime - Context->DvpBaseTime, DvpTimeForNFrames(1), EstimatedBaseTime, Context->DvpInterruptFrameCount, Context->DvpBaseTime );
			...
			Context->DvpInterruptFrameCount = 0;
			Context->DvpTimeAtZeroInterruptFrameCount =
			    Context->DvpBaseTime;
		...
		if (Context->DvpInterruptFrameCount <
		    Context->DvpWarmUpVideoFrames)
			break;

//printk( "Warm up tries was %d\n", Context->DvpwarmUpSynchronizationAttempts );

		if (Context->DvpwarmUpSynchronizationAttempts >=
		    DVP_WARM_UP_TRIES)
		...
		Context->DvpIntegrateForAtLeastNFrames =
		    DVP_MINIMUM_TIME_INTEGRATION_FRAMES;

	case DvpStarted:
		MonitorSignalEvent(MONITOR_EVENT_VIDEO_FIRST_FIELD_ACQUIRED,
				   NULL, "DvpInterrupt: First field acquired");
		break;
...
//printk( "Moving %12lld  %12lld - %016llx %016llx\n", (Now - Context->DvpRunFromTime), (Context->DvpBufferStack[Context->DvpNextBufferToFill % DVP_VIDEO_DECODE_BUFFER_STACK_SIZE].ExpectedFillTime - Now), Context->DvpRunFromTime, Context->DvpBufferStack[Context->DvpNextBufferToFill % DVP_VIDEO_DECODE_BUFFER_STACK_SIZE].ExpectedFillTime );
	...
	case DvpRunning:
		...
		Interrupts =
		    ((Now - Context->DvpTimeOfLastFrameInterrupt +
		      (DvpTimeForNFrames(1) / 2)) / DvpTimeForNFrames(1));
		if (Interrupts > 1) {
		...
		DvpVideoSysfsInterruptDecrementFrameCountingNotification
		    (Context);
		DvpVideoSysfsInterruptDecrementFrameCaptureNotification
		    (Context);

		if (Context->DvpMissedFramesInARow >
		    DVP_MAX_MISSED_FRAMES_BEFORE_POST_MORTEM)
		...
		if (Context->DvpCalculatingFrameTime ||
		    ...
		    ||
		    ((Context->DvpInterruptFrameCount <
		      (2 * Context->DvpIntegrateForAtLeastNFrames))
		     && ((Now - Context->DvpTimeOfLastFrameInterrupt) >
			 (DvpTimeForNFrames(1) + DVP_MAXIMUM_FRAME_JITTER)))) {
			if (!
			    ((Now - Context->DvpTimeOfLastFrameInterrupt) >
			     (DvpTimeForNFrames(1) + DVP_MAXIMUM_FRAME_JITTER)))
		...
		if (UpdateCorrectionFactor) {
			...
			if ((Context->DvpNextIntegrationRecord -
			     Context->DvpFirstIntegrationRecord) > 0) {
				HistoricDifference0 =
				    ((Now -
				      Context->DvpTimeAtZeroInterruptFrameCount)
				     << DVP_CORRECTION_FIXED_POINT_BITS) /
				    DvpTimeForNFrames
				    (Context->DvpInterruptFrameCount);
				HistoricDifference0Sign =
				    HistoricDifference0 <
				    Context->DvpFrameDurationCorrection;
				HistoricDifference0 =
				    HistoricDifference0Sign
				    ? (Context->DvpFrameDurationCorrection -
				       HistoricDifference0)
			...
			if ((Context->DvpNextIntegrationRecord -
			     Context->DvpFirstIntegrationRecord) > 1) {
				HistoricDifference1 =
				    (Context->DvpElapsedCaptureTimeRecord
				     [(Context->DvpNextIntegrationRecord -
				       1) % DVP_MAX_RECORDED_INTEGRATIONS]
				     << DVP_CORRECTION_FIXED_POINT_BITS) /
				    DvpTimeForNFrames
				    (Context->DvpCapturedFrameCountRecord
				     [(Context->DvpNextIntegrationRecord -
				       1) % DVP_MAX_RECORDED_INTEGRATIONS]);
				...
				if ((HistoricDifference0 > DVP_ONE_PPM) &&
				    ...
				    (HistoricDifference0Sign ==
				     HistoricDifference1Sign)) {
					Context->DvpTotalElapsedCaptureTime =
					    Context->DvpElapsedCaptureTimeRecord
					    [(Context->
					      DvpNextIntegrationRecord -
					      1) %
					     DVP_MAX_RECORDED_INTEGRATIONS];
					Context->DvpTotalCapturedFrameCount =
					    Context->DvpCapturedFrameCountRecord
					    [(Context->
					      DvpNextIntegrationRecord -
					      1) %
			...
			do {
				NewTotalElapsedTime =
				    Context->DvpTotalElapsedCaptureTime + (Now -
									   Context->DvpTimeAtZeroInterruptFrameCount);
				NewTotalFrameCount =
				    Context->DvpTotalCapturedFrameCount +
				    Context->DvpInterruptFrameCount;
				ArithmeticOverflowLikely =
				    (NewTotalElapsedTime !=
				     ((NewTotalElapsedTime <<
				       DVP_CORRECTION_FIXED_POINT_BITS) >>
				      DVP_CORRECTION_FIXED_POINT_BITS))
				    ||
				    ((DvpTimeForNFrames(NewTotalFrameCount) &
				      0xffffffff00000000ull) != 0);

				ThrowAnIntegration = ArithmeticOverflowLikely ||
				    ((Context->DvpNextIntegrationRecord -
				      Context->DvpFirstIntegrationRecord) >=
				     (DVP_MAX_RECORDED_INTEGRATIONS - 1));
			...
			AffectOfChangeOnPreviousFrameTimes =
			    DvpTimeForNFrames(Context->DvpFrameCount +
					      Context->DvpLeadInVideoFrames);
			AffectOfChangeOnPreviousFrameTimes =
			    (AffectOfChangeOnPreviousFrameTimes *
			     Abs(CorrectionFactorChange)) >>
			    DVP_CORRECTION_FIXED_POINT_BITS;
			Context->DvpBaseTime +=
			    (CorrectionFactorChange <
			     0) ? AffectOfChangeOnPreviousFrameTimes :
			    -AffectOfChangeOnPreviousFrameTimes;
		}
		//
		...
		if (!inrange
		    (Context->DvpFrameDurationCorrection,
		     (DVP_CORRECTION_FACTOR_ONE -
		      (DVP_MAX_SUPPORTED_PPM_CLOCK_ERROR * DVP_ONE_PPM)),
		     (DVP_CORRECTION_FACTOR_ONE +
		      (DVP_MAX_SUPPORTED_PPM_CLOCK_ERROR * DVP_ONE_PPM)))) {
			printk
			    ("DvpInterrupt - Correction factor %lld.%09lld outside reasonable rate, marking frame rate as invalid.\n",
			     (Context->DvpFrameDurationCorrection >>
			      DVP_CORRECTION_FIXED_POINT_BITS),
			     (((Context->DvpFrameDurationCorrection &
				0x3fffffff) *
			       1000000000) >> DVP_CORRECTION_FIXED_POINT_BITS));
		...
		if (!Context->StandardFrameRate) {
			...
			Context->DvpIntegrateForAtLeastNFrames =
			    DVP_MINIMUM_TIME_INTEGRATION_FRAMES / 2;
			...
			for (i = Context->DvpNextBufferToFill;
				...
				Context->DvpBufferStack[i %
							DVP_VIDEO_DECODE_BUFFER_STACK_SIZE].ExpectedFillTime
				    =
				    Now + DvpTimeForNFrames(i -
							    Context->DvpNextBufferToFill);

			Context->DvpFrameCount =
			    i - Context->DvpNextBufferToFill -
			    Context->DvpLeadInVideoFrames;
			Context->DvpBaseTime = Now;
		}
		//
		...
		Context->DvpCurrentDriftError =
		    (Abs(DriftError) <
		     Abs(Context->DvpLastFrameDriftError)) ? DriftError :
		    Context->DvpLastFrameDriftError;
		Context->DvpBaseTime =
		    Context->DvpBaseTime + Context->DvpLastDriftCorrection;
		Context->DvpDriftFrameCount = 0;
		Context->DvpLastDriftCorrection = 0;

		DriftLimit =
		    (1 *
		     DvpTimeForNFrames(DVP_MAXIMUM_TIME_INTEGRATION_FRAMES)) /
		    500000;
		...
		printk
		    ("New Correction factor %lld.%09lld(%d - %3d) [%3lld] - (%5d %6d) %5lld (%lld,%lld)(%s%lld.%09lld %s%lld.%09lld) \n",
		     (Context->DvpFrameDurationCorrection >>
		      DVP_CORRECTION_FIXED_POINT_BITS),
		     (((Context->DvpFrameDurationCorrection & 0x3fffffff) *
		       1000000000) >> DVP_CORRECTION_FIXED_POINT_BITS),
		...
		if (Context->DvpIntegrateForAtLeastNFrames >=
			...
			if (UpdateCorrectionFactor) {
				...
				Context->
				    DvpElapsedCaptureTimeRecord
				    [Context->DvpNextIntegrationRecord %
				     DVP_MAX_RECORDED_INTEGRATIONS]
				    = (Now -
				       Context->
				       DvpTimeAtZeroInterruptFrameCount);
				Context->
				    DvpCapturedFrameCountRecord
				    [Context->DvpNextIntegrationRecord %
				     DVP_MAX_RECORDED_INTEGRATIONS]
				    = Context->DvpInterruptFrameCount;
				Context->DvpNextIntegrationRecord++;
...
static void DvpEventHandler(stm_se_event_context_h EventContext,
			    struct stream_event_s *Event)
{
	...
	case STREAM_EVENT_OUTPUT_SIZE_CHANGED:
		if (!Context->OutputCropTargetReached &&
		    ...
		    (Event->u.rectangle.width ==
		     Context->OutputCropTarget.Width)
		    && (Event->u.rectangle.height ==
			Context->OutputCropTarget.Height)) {
			DvpVideoSysfsProcessDecrementOutputCropTargetReachedNotification
			    (Context);
...
static void DvpPerformOutputCropStep(dvp_v4l2_video_handle_t * Context)
{
	...
	Context->OutputCrop.X =
	    ((Context->OutputCropStart.X * (Steps - Step)) +
	     (Context->OutputCropTarget.X * Step)) / Steps;
	Context->OutputCrop.Y =
	    ((Context->OutputCropStart.Y * (Steps - Step)) +
	     (Context->OutputCropTarget.Y * Step)) / Steps;
	Context->OutputCrop.Width =
	    ((Context->OutputCropStart.Width * (Steps - Step)) +
	     (Context->OutputCropTarget.Width * Step)) / Steps;
	Context->OutputCrop.Height =
	    ((Context->OutputCropStart.Height * (Steps - Step)) +
	     (Context->OutputCropTarget.Height * Step)) / Steps;
	...
	if (Context->OutputCropStepping) {
		Context->OutputCrop.X =
		    (Context->OutputCrop.X + 1) & 0xfffffffe;
		Context->OutputCrop.Y =
		    (Context->OutputCrop.Y + 1) & 0xfffffffe;
		Context->OutputCrop.Width =
		    (Context->OutputCrop.Width + 1) & 0xfffffffe;
		Context->OutputCrop.Height =
		    (Context->OutputCrop.Height + 1) & 0xfffffffe;
	}
	//
	// Now use the values
	//
...
static int DvpVideoThread(void *data)
{
	...
	Result = dvb_playback_add_stream(Context->DeviceContext->Playback, STM_SE_MEDIA_VIDEO, STM_SE_STREAM_ENCODING_VIDEO_DVP, 0, /* encoding_flags */ Context->DeviceContext->DvbContext->DvbAdapter->num, INVALID_MEDIA_ID, Context->DeviceContext->Id,	// SurfaceId .....
				      &Context->DeviceContext->VideoStream);
	if (Result < 0) {
		printk("DvpVideoThread - dvb_playback_add_stream failed with %d\n",
		       Result);
		return -EINVAL;
	}
	...
	DvbStreamRegisterEventSignalCallback(Context->
					     DeviceContext->VideoStream,
					     (stm_se_event_context_h) Context,
					     (stm_se_event_play_stream_callback_t)
					     DvpEventHandler);
	...
	DvbStreamSetOption(Context->DeviceContext->VideoStream,
			   DVB_OPTION_VIDEO_ASPECT_RATIO, VIDEO_FORMAT_16_9);
	DvbStreamSetOption(Context->DeviceContext->VideoStream,
			   DVB_OPTION_VIDEO_DISPLAY_FORMAT, VIDEO_FULL_SCREEN);
	DvbStreamSetOption(Context->DeviceContext->VideoStream,
			   DVB_OPTION_AV_SYNC, DVB_OPTION_VALUE_ENABLE);
	DvbStreamSetOption(Context->DeviceContext->VideoStream,
	...
	while (Context->VideoRunning) {
		...
		while ((Context->DvpCaptureMode == NULL)
		       && Context->VideoRunning) {
			printk
			    ("DvpVideoThread - Attempting to run without a video standard specified, waiting for a VIDIOC_S_STD ioctl call.\n");
			down_interruptible(&Context->DvpVideoInterruptSem);
		...
		if ((Result == 0) && Context->VideoRunning
		    && !Context->FastModeSwitch)
		...
		while ((Result == 0) && Context->VideoRunning
		       && !Context->FastModeSwitch) {
	...
	Result =
	    dvb_playback_remove_stream(Context->DeviceContext->Playback,
				    Context->DeviceContext->VideoStream);
	Context->DeviceContext->VideoStream = NULL;

	if (Result < 0) {
		printk("Error in %s: dvb_playback_remove_stream failed\n",
		       __FUNCTION__);
		return -EINVAL;
	}
//
...
static int DvpSynchronizerThread(void *data)
{
	...
	while (Context->SynchronizerRunning) {
		...
		SYSFS_TEST_NOTIFY(FrameCountingNotification,
				  frame_counting_notification);
		SYSFS_TEST_NOTIFY(FrameCaptureNotification,
				  frame_capture_notification);
		SYSFS_TEST_NOTIFY(PostMortem, post_mortem);

		while (Context->SynchronizerRunning
		       && Context->SynchronizeEnabled && Context->Synchronize) {
			//
			...
			TriggerPoint =
			    Context->DvpBaseTime + ControlValue(VideoLatency) -
			    32;
			...
			Jiffies =
			    (unsigned int)(((long long)HZ * SleepTime) /
					   1000000);
			...
			do {
				if (!Context->SynchronizerRunning
				    || Context->Synchronize)
					break;
				...
				Now = ktime_to_us(Ktime);
				 ...
				 && Context->SynchronizerRunning
				 && Context->SynchronizeEnabled
				 && !Context->Synchronize);
...
/* Alain: 20120503: stm_se_display_synchronize STKPI function is being deprecated by the streaming engine. Thus this driver shouldn't be using it anymore. Removing that function only here, also mean that the whole synchronization thread is most probably not necessary anymore.
 * However, considering the current unused status of that driver, proper full cleanup of the code isn't really worth
 */
#if 0
			//
			...
			DvbDisplaySynchronize(STM_SE_MEDIA_VIDEO, Context->DeviceContext->Id);	// Trigger vsync lock
#endif
...
int DvpVideoIoctlSetFramebuffer(dvp_v4l2_video_handle_t * Context,
				unsigned int Width,
				unsigned int Height,
				unsigned int BytesPerLine, unsigned int Control)
{
	printk
	    ("VIDIOC_S_FBUF: DOING NOTHING !!!! - W = %4d, H = %4d, BPL = %4d, Crtl = %08x\n",
...
int DvpVideoIoctlSetStandard(dvp_v4l2_video_handle_t * Context, v4l2_std_id Id)
{
	int i;
...
//
	...
	for (i = 0; i < ARRAY_SIZE(DvpModeParamsTable); i++)
...
//
	...
	Result =
	    request_irq(Context->DvpIrq, DvpInterrupt, IRQF_DISABLED, "dvp",
			Context);

	if (Result != 0) {
		printk
		    ("DvpVideoIoctlOverlayStart - Cannot get irq %d (result = %d)\n",
	...
	Context->AncillaryInputBufferPhysicalAddress =
	    OSDEV_MallocPartitioned(DVP_ANCILLARY_PARTITION,
				    Context->AncillaryInputBufferSize);

	if (Context->AncillaryInputBufferPhysicalAddress == NULL) {
		printk
		    ("DvpVideoIoctlOverlayStart - Unable to allocate ANC input buffer.\n");
		free_irq(Context->DvpIrq, Context);
		return -ENOMEM;
	}

	Context->AncillaryInputBufferUnCachedAddress =
	    (unsigned char *)OSDEV_IOReMap((unsigned int)
					   Context->AncillaryInputBufferPhysicalAddress,
					   Context->AncillaryInputBufferSize);
	Context->AncillaryInputBufferInputPointer =
	    Context->AncillaryInputBufferUnCachedAddress;
	...
	if (IS_ERR(Task)) {
		printk
		    ("DvpVideoIoctlOverlayStart - Unable to start video thread\n");
		Context->VideoRunning = false;
		Context->SynchronizerRunning = false;
		OSDEV_IOUnMap((unsigned int)
			      Context->AncillaryInputBufferUnCachedAddress);
	...
	if (sched_setscheduler(Task, SCHED_RR, &Param)) {
		printk
		    ("DvpVideoIoctlOverlayStart - FAILED to set scheduling parameters to priority %d (SCHED_RR)\n",
...
//
	...
	if (IS_ERR(Task)) {
		printk
		    ("DvpVideoIoctlOverlayStart - Unable to start synchronizer thread\n");
		Context->VideoRunning = false;
		Context->SynchronizerRunning = false;
		OSDEV_IOUnMap((unsigned int)
			      Context->AncillaryInputBufferUnCachedAddress);
	...
	for (i = 0;
	     (i < 100) && (!Context->VideoRunning
			   || !Context->SynchronizerRunning); i++) {
		unsigned int Jiffies = ((HZ) / 1000) + 1;
	...
	if (!Context->VideoRunning || !Context->SynchronizerRunning) {
		printk
		    ("DvpVideoIoctlOverlayStart - FAILED to set start processes\n");
		Context->VideoRunning = false;
		Context->SynchronizerRunning = false;
		OSDEV_IOUnMap((unsigned int)
			      Context->AncillaryInputBufferUnCachedAddress);
...
int DvpVideoIoctlCrop(dvp_v4l2_video_handle_t * Context, struct v4l2_crop *Crop)
{
#if 0
	printk("VIDIOC_S_CROP:\n");
	printk("       %s %3dx%3d\n",
	       ((Crop->type ==
		 V4L2_BUF_TYPE_VIDEO_OVERLAY) ? "OutputWindow" :
		"InputWindow "), Crop->c.width, Crop->c.height);
#endif
	...
	if (Crop->type == V4L2_BUF_TYPE_VIDEO_OVERLAY) {
		if (!Context->OutputCropTargetReached
			...
			printk
			    ("DvpVideoIoctlCrop: Setting output crop before previous crop has reached display\n");
		}
		...
		if ((Context->OutputCropTarget.X == Context->OutputCropStart.X)
		    && (Context->OutputCropTarget.Y ==
			Context->OutputCropStart.Y)
		    && (Context->OutputCropTarget.Width ==
			Context->OutputCropStart.Width)
		    && (Context->OutputCropTarget.Height ==
			Context->OutputCropStart.Height)) {
			printk
			    ("DvpVideoIoctlCrop: Setting output crop to be unchanged - marking as target on display immediately.\n");
			DvpVideoSysfsProcessDecrementOutputCropTargetReachedNotification
			    (Context);
			Context->OutputCropTargetReached = true;
		} else {
			...
			default:
				printk
				    ("DvpVideoIoctlCrop: Unsupported output crop transition mode (%d) defaulting to single step. \n ",
			...
			case DVP_TRANSITION_MODE_STEP_OVER_N_VSYNCS:
				Context->OutputCropSteps =
				    ControlValue
				    (OutputCropTransitionModeParameter0);
				Context->OutputCropCurrentStep = 0;
				Context->OutputCropStepping = true;
				break;
			}
		...
		if (((Crop->c.left + Crop->c.width) > Context->ModeWidth) ||
			...
			printk
			    ("DvpVideoIoctlCrop: Input crop invalid for current mode, (%d + %d > %d) Or (%d + %d > %d).\n",
...
int DvpVideoIoctlSetControl(dvp_v4l2_video_handle_t * Context,
			    unsigned int Control, unsigned int Value)
{
	int ret;
	...
	case V4L2_CID_STM_DVPIF_RESTORE_DEFAULT:
		...
		Context->DvpControlExternalVRefPolarityPositive =
		    DVP_USE_DEFAULT;
		Context->DvpControlHRefPolarityPositive = DVP_USE_DEFAULT;
		Context->DvpControlActiveAreaAdjustHorizontalOffset =
		    DVP_USE_DEFAULT;
		Context->DvpControlActiveAreaAdjustVerticalOffset =
		    DVP_USE_DEFAULT;
		...
		Context->DvpControlOutputCropTransitionModeParameter0 =
		    DVP_USE_DEFAULT;
		...
		Context->DvpControlDefaultAncPageSize =
		    DVP_DEFAULT_ANCILLARY_PAGE_SIZE;
		Context->DvpControlDefaultAncInputBufferSize =
		    DVP_DEFAULT_ANCILLARY_INPUT_BUFFER_SIZE;
		...
		Context->DvpControlDefaultOutputCropTransitionMode =
		    DVP_TRANSITION_MODE_SINGLE_STEP;
		Context->DvpControlDefaultOutputCropTransitionModeParameter0 =
		    8;
		Context->DvpControlDefaultPixelAspectRatioCorrection =
		    DVP_PIXEL_ASPECT_RATIO_CORRECTION_MAX_VALUE;
		Context->DvpControlDefaultPictureAspectRatio =
		    DVP_PICTURE_ASPECT_RATIO_4_3;

#if 0
		Context->DvpControlOutputCropTransitionMode =
		    DVP_TRANSITION_MODE_STEP_OVER_N_VSYNCS;
	...
	case V4L2_CID_STM_DVPIF_BLANK:
		...
		ret =
		    DvbStreamEnable(Context->DeviceContext->VideoStream, Value);
		if (ret < 0) {
			printk
			    ("DvpVideoIoctlSetControl - DvbStreamEnable failed (%d)\n",
			     Value);
			return -EINVAL;
		}
	...
	case V4L2_CID_STM_DVPIF_INCOMPLETE_FIRST_PIXEL:
		CheckAndSet("INCOMPLETE_FIRST_PIXEL", 0, 1,
			    Context->DvpControlIncompleteFirstPixel);
		break;
	case V4L2_CID_STM_DVPIF_ODD_PIXEL_COUNT:
		CheckAndSet("ODD_PIXEL_COUNT", 0, 1,
			    Context->DvpControlOddPixelCount);
		break;
	case V4L2_CID_STM_DVPIF_VSYNC_BOTTOM_HALF_LINE_ENABLE:
		CheckAndSet("VSYNC_BOTTOM_HALF_LINE_ENABLE", 0, 1,
			    Context->DvpControlVsyncBottomHalfLineEnable);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNC:
		CheckAndSet("EXTERNAL_SYNC", 0, 1,
			    Context->DvpControlExternalSync);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNC_POLARITY:
		CheckAndSet("EXTERNAL_SYNC_POLARITY", 0, 1,
			    Context->DvpControlExternalSyncPolarity);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNCHRO_OUT_OF_PHASE:
		CheckAndSet("EXTERNAL_SYNCHRO_OUT_OF_PHASE", 0, 1,
			    Context->DvpControlExternalSynchroOutOfPhase);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_VREF_ODD_EVEN:
		CheckAndSet("EXTERNAL_VREF_ODD_EVEN", 0, 1,
			    Context->DvpControlExternalVRefOddEven);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_VREF_POLARITY_POSITIVE:
		CheckAndSet("EXTERNAL_VREF_POLARITY_POSITIVE", 0, 1,
			    Context->DvpControlExternalVRefPolarityPositive);
		break;
	case V4L2_CID_STM_DVPIF_HREF_POLARITY_POSITIVE:
		CheckAndSet("HREF_POLARITY_POSITIVE", 0, 1,
			    Context->DvpControlHRefPolarityPositive);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET:
		CheckAndSet("ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET", -260, 260,
			    Context->DvpControlActiveAreaAdjustHorizontalOffset);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_VERTICAL_OFFSET:
		CheckAndSet("ACTIVE_AREA_ADJUST_VERTICAL_OFFSET", -256, 256,
			    Context->DvpControlActiveAreaAdjustVerticalOffset);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_WIDTH:
		CheckAndSet("ACTIVE_AREA_ADJUST_WIDTH", -2048, 2048,
			    Context->DvpControlActiveAreaAdjustWidth);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HEIGHT:
		CheckAndSet("ACTIVE_AREA_ADJUST_HEIGHT", -2048, 2048,
			    Context->DvpControlActiveAreaAdjustHeight);
		break;
	...
	case V4L2_CID_STM_DVPIF_VIDEO_LATENCY:
		CheckAndSet("VIDEO_LATENCY", 0, 1000000,
			    Context->DvpControlVideoLatency);
		break;
	case V4L2_CID_STM_DVPIF_ANC_PAGE_SIZE_SPECIFIED:
		CheckAndSet("ANC_PAGE_SIZE_SPECIFIED", 0, 1,
			    Context->DvpControlAncPageSizeSpecified);
		break;
	case V4L2_CID_STM_DVPIF_ANC_PAGE_SIZE:
		CheckAndSet("ANC_PAGE_SIZE", 0, 4096,
			    Context->DvpControlAncPageSize);
		break;
	case V4L2_CID_STM_DVPIF_ANC_INPUT_BUFFER_SIZE:
		Value &= 0xfffffff0;
		CheckAndSet("ANC_INPUT_BUFFER_SIZE", 0, 0x100000,
			    Context->DvpControlAncInputBufferSize);
		break;
	case V4L2_CID_STM_DVPIF_HORIZONTAL_RESIZE_ENABLE:
		CheckAndSet("HORIZONTAL_RESIZE_ENABLE", 0, 1,
			    Context->DvpControlHorizontalResizeEnable);
		DvpRecalculateScaling(Context);
		break;
	case V4L2_CID_STM_DVPIF_VERTICAL_RESIZE_ENABLE:
		CheckAndSet("VERTICAL_RESIZE_ENABLE", 0, 0,
			    Context->DvpControlVerticalResizeEnable);
		DvpRecalculateScaling(Context);
		break;
	case V4L2_CID_STM_DVPIF_TOP_FIELD_FIRST:
		CheckAndSet("TOP_FIELD_FIRST", 0, 1,
			    Context->DvpControlTopFieldFirst);
		break;
	case V4L2_CID_STM_DVPIF_VSYNC_LOCK_ENABLE:
		CheckAndSet("VSYNC_LOCK_ENABLE", 0, 1,
			    Context->DvpControlVsyncLockEnable);
		break;
	case V4L2_CID_STM_DVPIF_OUTPUT_CROP_TRANSITION_MODE:
		CheckAndSet("OUTPUT_CROP_TRANSITION_MODE", 0, 1,
			    Context->DvpControlOutputCropTransitionMode);
		break;
	case V4L2_CID_STM_DVPIF_OUTPUT_CROP_TRANSITION_MODE_PARAMETER_0:
		CheckAndSet("OUTPUT_CROP_TRANSITION_MODE_PARAMETER_0", 0,
			    0x7fffffff,
			    Context->DvpControlOutputCropTransitionModeParameter0);
		break;
	case V4L2_CID_STM_DVPIF_PIXEL_ASPECT_RATIO_CORRECTION:
		CheckAndSet("PIXEL_ASPECT_RATIO_CORRECTION",
			    DVP_PIXEL_ASPECT_RATIO_CORRECTION_MIN_VALUE,
			    DVP_PIXEL_ASPECT_RATIO_CORRECTION_MAX_VALUE,
			    Context->DvpControlPixelAspectRatioCorrection);

		// Set appropriate policy to manage non progressive zoom format
		DvbStreamSetOption(Context->DeviceContext->VideoStream,
				   DVB_OPTION_PIXEL_ASPECT_RATIO_CORRECTION,
				   Context->DvpControlPixelAspectRatioCorrection);
		break;
	case V4L2_CID_STM_DVPIF_PICTURE_ASPECT_RATIO:
		{
			...
			CheckAndSet("PICTURE_ASPECT_RATIO",
				    DVP_PICTURE_ASPECT_RATIO_4_3,
				    DVP_PICTURE_ASPECT_RATIO_16_9,
				    Context->DvpControlPictureAspectRatio);
			...
			Mode = Context->DvpCaptureMode->Mode;
			if (Context->DvpControlPictureAspectRatio ==
			    DVP_PICTURE_ASPECT_RATIO_4_3) {
				switch (Mode) {
				...
				case DVP_720_480_P59940:
					Context->
					    DeviceContext->PixelAspectRatio.
					    Numerator = 8;
					Context->
					    DeviceContext->PixelAspectRatio.
					    Denominator = 9;
			...
			} else if (Context->DvpControlPictureAspectRatio ==
				   DVP_PICTURE_ASPECT_RATIO_16_9) {
				switch (Mode) {
				case DVP_720_480_I60000:
				case DVP_720_480_P60000:
			    ...
			    unsigned int Control, unsigned int *Value)
{
	...
	case V4L2_CID_STM_DVPIF_FULL_RANGE:
		...
		break;
	case V4L2_CID_STM_DVPIF_INCOMPLETE_FIRST_PIXEL:
		GetValue("INCOMPLETE_FIRST_PIXEL",
			 Context->DvpControlIncompleteFirstPixel);
		break;
	case V4L2_CID_STM_DVPIF_ODD_PIXEL_COUNT:
		...
		break;
	case V4L2_CID_STM_DVPIF_VSYNC_BOTTOM_HALF_LINE_ENABLE:
		GetValue("VSYNC_BOTTOM_HALF_LINE_ENABLE",
			 Context->DvpControlVsyncBottomHalfLineEnable);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNC:
		...
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNC_POLARITY:
		GetValue("EXTERNAL_SYNC_POLARITY",
			 Context->DvpControlExternalSyncPolarity);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_SYNCHRO_OUT_OF_PHASE:
		GetValue("EXTERNAL_SYNCHRO_OUT_OF_PHASE",
			 Context->DvpControlExternalSynchroOutOfPhase);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_VREF_ODD_EVEN:
		GetValue("EXTERNAL_VREF_ODD_EVEN",
			 Context->DvpControlExternalVRefOddEven);
		break;
	case V4L2_CID_STM_DVPIF_EXTERNAL_VREF_POLARITY_POSITIVE:
		GetValue("EXTERNAL_VREF_POLARITY_POSITIVE",
			 Context->DvpControlExternalVRefPolarityPositive);
		break;
	case V4L2_CID_STM_DVPIF_HREF_POLARITY_POSITIVE:
		GetValue("HREF_POLARITY_POSITIVE",
			 Context->DvpControlHRefPolarityPositive);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET:
		GetValue("ACTIVE_AREA_ADJUST_HORIZONTAL_OFFSET",
			 Context->DvpControlActiveAreaAdjustHorizontalOffset);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_VERTICAL_OFFSET:
		GetValue("ACTIVE_AREA_ADJUST_VERTICAL_OFFSET",
			 Context->DvpControlActiveAreaAdjustVerticalOffset);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_WIDTH:
		GetValue("ACTIVE_AREA_ADJUST_WIDTH",
			 Context->DvpControlActiveAreaAdjustWidth);
		break;
	case V4L2_CID_STM_DVPIF_ACTIVE_AREA_ADJUST_HEIGHT:
		GetValue("ACTIVE_AREA_ADJUST_HEIGHT",
			 Context->DvpControlActiveAreaAdjustHeight);
		break;
	case V4L2_CID_STM_DVPIF_COLOUR_MODE:
	...
	case V4L2_CID_STM_DVPIF_VIDEO_LATENCY:
		...
		break;
	case V4L2_CID_STM_DVPIF_ANC_PAGE_SIZE_SPECIFIED:
		GetValue("ANC_PAGE_SIZE_SPECIFIED",
			 Context->DvpControlAncPageSizeSpecified);
		break;
	case V4L2_CID_STM_DVPIF_ANC_PAGE_SIZE:
		...
		break;
	case V4L2_CID_STM_DVPIF_ANC_INPUT_BUFFER_SIZE:
		GetValue("ANC_INPUT_BUFFER_SIZE",
			 Context->DvpControlAncInputBufferSize);
		break;
	case V4L2_CID_STM_DVPIF_HORIZONTAL_RESIZE_ENABLE:
		GetValue("HORIZONTAL_RESIZE_ENABLE",
			 Context->DvpControlHorizontalResizeEnable);
		break;
	case V4L2_CID_STM_DVPIF_VERTICAL_RESIZE_ENABLE:
		GetValue("VERTICAL_RESIZE_ENABLE",
			 Context->DvpControlVerticalResizeEnable);
		break;
	case V4L2_CID_STM_DVPIF_TOP_FIELD_FIRST:
		...
		break;
	case V4L2_CID_STM_DVPIF_VSYNC_LOCK_ENABLE:
		GetValue("VSYNC_LOCK_ENABLE",
			 Context->DvpControlVsyncLockEnable);
		break;
	case V4L2_CID_STM_DVPIF_OUTPUT_CROP_TRANSITION_MODE:
		GetValue("OUTPUT_CROP_TRANSITION_MODE",
			 Context->DvpControlOutputCropTransitionMode);
		break;
	case V4L2_CID_STM_DVPIF_OUTPUT_CROP_TRANSITION_MODE_PARAMETER_0:
		GetValue("OUTPUT_CROP_TRANSITION_MODE_PARAMETER_0",
			 Context->DvpControlOutputCropTransitionModeParameter0);
		break;
	case V4L2_CID_STM_DVPIF_PIXEL_ASPECT_RATIO_CORRECTION:
		GetValue("PIXEL_ASPECT_RATIO_CORRECTION",
			 Context->DvpControlPixelAspectRatioCorrection);
		break;
	case V4L2_CID_STM_DVPIF_PICTURE_ASPECT_RATIO:
		GetValue("PICTURE_ASPECT_RATIO",
			 Context->DvpControlPictureAspectRatio);
		break;
	default:
		printk("Unknown\n");
					 ...
					 unsigned int *ActualSize)
{
	...
	if (DesiredCount == 0) {
		if (Context->AncillaryBufferCount == 0) {
			printk
			    ("DvpVideoIoctlAncillaryRequestBuffers - Attempt to free when No buffers allocated.\n");
			return -EINVAL;
		}
		...
		OSDEV_IOUnMap((unsigned int)
			      Context->AncillaryBufferUnCachedAddress);
		OSDEV_FreePartitioned(DVP_ANCILLARY_PARTITION,
	...
	if (Context->AncillaryBufferCount != 0) {
		printk
		    ("DvpVideoIoctlAncillaryRequestBuffers - Attempt to allocate buffers when buffers are already mapped.\n");
		return -EINVAL;
	}
	//
	...
	Clamp(DesiredCount, DVP_MIN_ANCILLARY_BUFFERS,
	      DVP_MAX_ANCILLARY_BUFFERS);

	Clamp(DesiredSize, DVP_MIN_ANCILLARY_BUFFER_SIZE,
	      DVP_MAX_ANCILLARY_BUFFER_SIZE);

	if ((DesiredSize % DVP_ANCILLARY_BUFFER_CHUNK_SIZE) != 0)
		DesiredSize +=
		    (DVP_ANCILLARY_BUFFER_CHUNK_SIZE -
		     (DesiredSize % DVP_ANCILLARY_BUFFER_CHUNK_SIZE));
	...
	if (Context->AncillaryBufferPhysicalAddress == NULL) {
		printk
		    ("DvpVideoIoctlAncillaryRequestBuffers - Unable to allocate buffers.\n");
		return -ENOMEM;
	}
	...
	Context->AncillaryBufferUnCachedAddress =
	    (unsigned char *)OSDEV_IOReMap((unsigned int)
					   Context->AncillaryBufferPhysicalAddress,
					   DesiredSize * DesiredCount);
	memset(Context->AncillaryBufferUnCachedAddress, 0x00,
	       DesiredCount * DesiredSize);
	...
	memset(Context->AncillaryBufferState, 0x00,
	       DVP_MAX_ANCILLARY_BUFFERS * sizeof(AncillaryBufferState_t));
	for (i = 0; i < Context->AncillaryBufferCount; i++) {
		Context->AncillaryBufferState[i].PhysicalAddress =
		    Context->AncillaryBufferPhysicalAddress + (i * DesiredSize);
		Context->AncillaryBufferState[i].UnCachedAddress =
		    Context->AncillaryBufferUnCachedAddress + (i * DesiredSize);
				      ...
				      unsigned int *Bytes, unsigned int *Size)
{
	if (Index >= Context->AncillaryBufferCount) {
		printk
		    ("DvpVideoIoctlAncillaryQueryBuffer - Index out of bounds (%d).\n",
		     Index);
		return -EINVAL;
	}
//
...
//
	...
	if (Context->AncillaryBufferState[Index].Queued ||
	    Context->AncillaryBufferState[Index].Done) {
		printk
		    ("DvpVideoIoctlAncillaryQueryBuffer - Buffer already queued or awaiting dequeing.\n");
		return -EINVAL;
	}
//

	memset(Context->AncillaryBufferState[Index].UnCachedAddress, 0x00,
	       Context->AncillaryBufferSize);
	Context->AncillaryBufferState[Index].Queued = true;

	Context->AncillaryBufferQueue[Context->AncillaryBufferNextQueueIndex %
				      DVP_MAX_ANCILLARY_BUFFERS] = Index;
	Context->AncillaryBufferNextQueueIndex++;
...
int DvpVideoIoctlAncillaryDeQueueBuffer(dvp_v4l2_video_handle_t * Context,
					unsigned int *Index, bool Blocking)
{
	do {
		if (Blocking)
...
//
		...
		if ((Context->AncillaryBufferCount == 0)
		    || !Context->AncillaryStreamOn) {
			printk
			    ("DvpVideoIoctlAncillaryDeQueueBuffer - Shutdown/StreamOff while waiting.\n");
			return -EINVAL;
		}
//

		if (Context->AncillaryBufferNextDeQueueIndex <
		    Context->AncillaryBufferNextFillIndex) {
			*Index =
			    Context->
			    AncillaryBufferQueue
			...
			if (!Context->AncillaryBufferState[*Index].Done)
				printk
				    ("DvpVideoIoctlAncillaryDeQueueBuffer - Internal state error, buffer is in done queue, but not marked as done - Implementation Error.\n");
