...
Source file name : dvb_avr_export.h
...
enum {
	...
	V4L2_CID_STM_AVR_AUDIO_MUTE, V4L2_CID_STM_AUDIO_MUTE =
	    V4L2_CID_STM_AVR_AUDIO_MUTE,
	V4L2_CID_STM_AVR_AUDIO_FORMAT_RECOGNIZER,
	V4L2_CID_STM_AUDIO_FORMAT_RECOGNIZER =
	    V4L2_CID_STM_AVR_AUDIO_FORMAT_RECOGNIZER,

	V4L2_CID_STM_AVR_AUDIO_AAC_DECODE, V4L2_CID_STM_AUDIO_AAC_DECODE =
	    V4L2_CID_STM_AVR_AUDIO_AAC_DECODE,
