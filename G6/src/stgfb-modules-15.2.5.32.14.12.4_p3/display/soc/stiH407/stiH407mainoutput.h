/***********************************************************************
 *
 * File: display/soc/stiH407/stiH407mainoutput.h
...
#ifndef _STiH407MAINOUTPUT_H
#define _STiH407MAINOUTPUT_H

#include <display/ip/tvout/stmmaintvoutput.h>
...
class CSTmClockLLA;
class CSTmTVOutDENC;
class CSTmMisrMainTVOut;


class CSTiH407MainOutput: public CSTmMainTVOutput
{
public:
  CSTiH407MainOutput( CDisplayDevice         *pDev,
                      CSTmVTG                *pVTG,
                      CSTmTVOutDENC          *pDENC,
                      CGammaMixer            *pMixer,
                      CSTmFSynth             *pFSynth,
...
private:
  ...
  // Private MISR implementation
  CSTmMisrMainTVOut           *m_pMisrMain;
  ...
  CSTiH407MainOutput(const CSTiH407MainOutput&);
  CSTiH407MainOutput& operator=(const CSTiH407MainOutput&);
};


#endif //_STiH407MAINOUTPUT_H
