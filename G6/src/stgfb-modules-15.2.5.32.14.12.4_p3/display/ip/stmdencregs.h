...
#define DENC_VPS0   0x19 /* Video Programming Sys pt[7:0]          ->[7:0]   */
#define DENC_VPS1   0x1a /* Video Programming Sys c[1:0] np[5:0]   ->[7:0]   */
#define DENC_VPS2   0x1b /* Video Programming Sys min[4:0] c[3:2]  ->[7:0]   */
#define DENC_VPS3   0x1c /* Video Programming Sys m2[2:0] h[4:0]   ->[7:0]   */
#define DENC_VPS4   0x1d /* Video Programming Sys np[7:6] d[4:0] m3->[7:0]   */
#define DENC_VPS5   0x1e /* Video Programming Sys s[1-0] cni[3:0]  ->[7:0]   */
...
#define DENC_CHROMA_DELAY    0x6c /* Main component chroma path delay        */
#define DENC_CHROMA_DELAY_EN 0x6d /* Enable DENC_CHROMA_DELAY                */
...
/* Common chroma delay defintions for CFG9 and CHROMA_DELAY */
#define DENC_CHROMA_DEL_P_0_5       (0x0)
#define DENC_CHROMA_DEL_ZERO        (0x1)
#define DENC_CHROMA_DEL_M_0_5       (0x2)
#define DENC_CHROMA_DEL_M_1_0       (0x3)
#define DENC_CHROMA_DEL_M_1_5       (0x4)
#define DENC_CHROMA_DEL_M_2_0       (0x5)
#define DENC_CHROMA_DEL_P_2_5       (0xC)
#define DENC_CHROMA_DEL_P_2_0       (0xD)
#define DENC_CHROMA_DEL_P_1_5       (0xE)
#define DENC_CHROMA_DEL_P_1_0       (0xF)
...
#define DENC_CFG9_DEL_SHIFT       (4)
#define DENC_CFG9_DEL(x)          ((x)<<DENC_CFG9_DEL_SHIFT)
#define DENC_CFG9_DEL_MASK        (DENC_CFG9_DEL(0xF))
...
#define DENC_CFG11_MAIN_IF_DELAY          (0x1<<2)
...
/* DENC_STA ---------------------------------------------------------------- */
#define DENC_STA_BUFF1_FREED              (0x1<<4)
#define DENC_STA_BUFF2_FREED              (0x1<<5)
...
#define DENC_CGMS1_IEC61880_B7_SHIFT      (5)
#define DENC_CGMS1_IEC61880_B8_SHIFT      (4)
#define DENC_CGMS1_IEC61880_B9_SHIFT      (3)
#define DENC_CGMS1_IEC61880_B10_SHIFT     (2)
#define DENC_CGMS1_IEC61880_B11_SHIFT     (1)
...
#define DENC_CMTTX_C_MULT_SHIFT          (4)
#define DENC_CMTTX_C_MULT_MASK           (0xF<<DENC_CMTTX_C_MULT_SHIFT)
