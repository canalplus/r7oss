                    ...
                    int  fixedpointONE)
{
  ...
  if(pixelpos < 0)
  {
    TRC( TRC_ID_ERROR, "Get5TapFilterSetup - start position out of range" );
    TRC( TRC_ID_ERROR, "Get5TapFilterSetup - pixelpos = 0x%08x increment = 0x%08x",  pixelpos,increment );
    /*
