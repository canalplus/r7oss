/***********************************************************************
 *
 * File: display/ip/hdmi/stmhdmiregs.h
...
#define STM_HDMI_INT_FILTER        0x23C
...
#define STM_HDMI_INT_PLL_LCK                   (1L<<5)
...
#define STM_HDMI_HPD_FILTER_EN                 (1L<<0)
#define STM_HDMI_SINK_TERM_FILTER_EN           (1L<<1)
#define STM_HDMI_IT_PRESCALER                  (0x1F0)
#define STM_HDMI_NOISE_SUPP_WIDTH              (0xFF0000)
...
#define STM_HDMI_STA_PLL_LCK                   (1L<<5)
#define STM_HDMI_STA_SINK_TERM                 (1L<<6)
...
#define STM_HDMI_AUD_CFG_CTS_CLK_64FS_N_128FS  (1L<<17)
...
#define STM_HDMI_AUD_CFG_DISABLE_AUDIO_TRANSMISSION (1L<<24)
#define STM_HDMI_AUD_CFG_FIFO_0_VALID               (1L<<28)
#define STM_HDMI_AUD_CFG_FIFO_01_VALID              (3L<<28)
#define STM_HDMI_AUD_CFG_FIFO_012_VALID             (7L<<28)
#define STM_HDMI_AUD_CFG_FIFO_0123_VALID            (15L<<28)
#define STM_HDMI_AUD_CFG_FIFO_MASK                  (15L<<28)

/*
 * HDMI 1.3 cell audio config bits
 */
#define STM_HDMI_AUD_CFG_FOUR_SP_PER_TRANSFER  (1L<<22)
#define STM_HDMI_AUD_CFG_FORCED_HBR_BBITS      (1L<<23)
#define STM_HDMI_AUD_CFG_SELECT_SPDIF_IN_0     (1L<<27)
