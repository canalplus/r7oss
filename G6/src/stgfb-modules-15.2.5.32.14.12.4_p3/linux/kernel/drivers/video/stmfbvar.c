...
static const struct standard_list_entry stmfbio_standard_list[] = {
  E(STM_TIMING_MODE_480I59940_13500,       STM_OUTPUT_STD_NTSC_M,    STMFBIO_STD_NTSC_M,       "NTSC-M"       ),
  E(STM_TIMING_MODE_480I59940_13500,       STM_OUTPUT_STD_NTSC_J,    STMFBIO_STD_NTSC_M_JP,    "NTSC-J"       ),
  E(STM_TIMING_MODE_480I59940_13500,       STM_OUTPUT_STD_NTSC_443,  STMFBIO_STD_NTSC_443,     "NTSC-443"     ),
  E(STM_TIMING_MODE_480I59940_13500,       STM_OUTPUT_STD_PAL_M,     STMFBIO_STD_PAL_M,        "PAL-M"        ),
  E(STM_TIMING_MODE_480I59940_13500,       STM_OUTPUT_STD_PAL_60,    STMFBIO_STD_PAL_60,       "PAL-60"       ),
  E(STM_TIMING_MODE_576I50000_13500,       STM_OUTPUT_STD_PAL_BDGHI, STMFBIO_STD_PAL,          "PAL"          ),
  E(STM_TIMING_MODE_576I50000_13500,       STM_OUTPUT_STD_PAL_N,     STMFBIO_STD_PAL_N,        "PAL-N"        ),
  E(STM_TIMING_MODE_576I50000_13500,       STM_OUTPUT_STD_PAL_Nc,    STMFBIO_STD_PAL_Nc,       "PAL-Nc"       ),
  E(STM_TIMING_MODE_576I50000_13500,       STM_OUTPUT_STD_SECAM,     STMFBIO_STD_SECAM,        "SECAM"        ),
  E(STM_TIMING_MODE_480P60000_27027,       STM_OUTPUT_STD_SMPTE293M, STMFBIO_STD_480P_60,      "480p@60"      ),
  E(STM_TIMING_MODE_480P59940_27000,       STM_OUTPUT_STD_SMPTE293M, STMFBIO_STD_480P_59_94,   "480p@59.94"   ),
  E(STM_TIMING_MODE_576P50000_27000,       STM_OUTPUT_STD_SMPTE293M, STMFBIO_STD_576P_50,      "576p"         ),
  E(STM_TIMING_MODE_1080P60000_148500,     STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_60,     "1080p@60"     ),
  E(STM_TIMING_MODE_1080P59940_148352,     STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_59_94,  "1080p@59.94"  ),
  E(STM_TIMING_MODE_1080P50000_148500,     STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_50,     "1080p@50"     ),
  E(STM_TIMING_MODE_1080P30000_74250,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_30,     "1080p@30"     ),
  E(STM_TIMING_MODE_1080P29970_74176,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_29_97,  "1080p@29.97"  ),
  E(STM_TIMING_MODE_1080P25000_74250,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_25,     "1080p@25"     ),
  E(STM_TIMING_MODE_1080P24000_74250,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_24,     "1080p@24"     ),
  E(STM_TIMING_MODE_1080P23976_74176,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080P_23_976, "1080p@23.976" ),
  E(STM_TIMING_MODE_1080I60000_74250,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080I_60,     "1080i@60"     ),
  E(STM_TIMING_MODE_1080I59940_74176,      STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080I_59_94,  "1080i@59.94"  ),
  E(STM_TIMING_MODE_1080I50000_74250_274M, STM_OUTPUT_STD_SMPTE274M, STMFBIO_STD_1080I_50,     "1080i@50"     ),
  E(STM_TIMING_MODE_720P60000_74250,       STM_OUTPUT_STD_SMPTE296M, STMFBIO_STD_720P_60,      "720p@60"      ),
  E(STM_TIMING_MODE_720P59940_74176,       STM_OUTPUT_STD_SMPTE296M, STMFBIO_STD_720P_59_94,   "720p@59.94"   ),
  E(STM_TIMING_MODE_720P50000_74250,       STM_OUTPUT_STD_SMPTE296M, STMFBIO_STD_720P_50,      "720p@50"      ),
  E(STM_TIMING_MODE_4K2K29970_296703,      STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_29_97,  "4K2Kp@29.97" ),
  E(STM_TIMING_MODE_4K2K30000_297000,      STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_30,     "4K2Kp@30"    ),
  E(STM_TIMING_MODE_4K2K25000_297000,      STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_25,     "4K2Kp@25"    ),
  E(STM_TIMING_MODE_4K2K23980_296703,      STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_23_98,  "4K2Kp@23.98" ),
  E(STM_TIMING_MODE_4K2K24000_297000,      STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_24,     "4K2Kp@24"    ),
  E(STM_TIMING_MODE_4K2K24000_297000_WIDE, STM_OUTPUT_STD_HDMI_LLC_EXT, STMFBIO_STD_4K2KP_24_WIDE,"4K2Kp_WIDE@24"),
  E(STM_TIMING_MODE_480P60000_25200,       STM_OUTPUT_STD_VGA,       STMFBIO_STD_VGA_60,       "VGA@60"       ),
  E(STM_TIMING_MODE_480P59940_25180,       STM_OUTPUT_STD_VGA,       STMFBIO_STD_VGA_59_94,    "VGA@59.94"    ),
  E(STM_TIMING_MODE_768P60000_65000,       STM_OUTPUT_STD_XGA,       STMFBIO_STD_XGA_60,       "XGA@60"       ),
  E(STM_TIMING_MODE_768P70000_75000,       STM_OUTPUT_STD_XGA,       STMFBIO_STD_XGA_70,       "XGA@70"       ),
  E(STM_TIMING_MODE_768P75000_78750,       STM_OUTPUT_STD_XGA,       STMFBIO_STD_XGA_75,       "XGA@75"       ),
  E(STM_TIMING_MODE_768P85000_94500,       STM_OUTPUT_STD_XGA,       STMFBIO_STD_XGA_85,       "XGA@85"       ),
  E(STM_TIMING_MODE_1024P60000_108000,     STM_OUTPUT_STD_XGA,       STMFBIO_STD_XGA_60,       "SXGA@60"      ),
  E(STM_TIMING_MODE_540P59940_36343,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD3660,     "QFHD3660"     ),
  E(STM_TIMING_MODE_540P49993_36343,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD3650,     "QFHD3650"     ),
  E(STM_TIMING_MODE_540P59945_54857_WIDE,  STM_OUTPUT_STD_NTG5,      STMFBIO_STD_WQFHD5660,    "WQFHD5660"    ),
  E(STM_TIMING_MODE_540P49999_54857_WIDE,  STM_OUTPUT_STD_NTG5,      STMFBIO_STD_WQFHD5650,    "WQFHD5650"    ),
  E(STM_TIMING_MODE_540P59945_54857,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD5660,     "QFHD5660"     ),
  E(STM_TIMING_MODE_540P49999_54857,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD5650,     "QFHD5650"     ),
  E(STM_TIMING_MODE_540P29970_18000,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD1830,     "QFHD1830"     ),
  E(STM_TIMING_MODE_540P25000_18000,       STM_OUTPUT_STD_NTG5,      STMFBIO_STD_QFHD1825,     "QFHD1825"     ),
};
#undef E
                           ...
                           const struct stmfbio_plane_config *c)
{
  ...
  printk ("stmfbio_plane_config %3s (@ %p) %ux%u (rescale to %u,%u-%ux%u) %u (%s) @ %x pitch %u %dbpp\n",
          prefix, c,
                        ...
                        const struct stmfbio_planeinfo *plane)
{
  ...
  if (x < 0)
    return -EIO;
  if (c->source.w <  inputRange.min_val.width
      || c->source.w > inputRange.max_val.width
      || c->source.h < inputRange.min_val.height
      || c->source.h > inputRange.max_val.height
     )
    /* FIXME: or should we just clamp here? */
    /* FIXME2: min/max width and height probably apply to dest, not source?!*/
    return -EINVAL;
#if 0
  if (c->dest.dim.w < inputRange.min_val.width
      || c->dest.dim.w > inputRange.max_val.width
      || c->dest.dim.h < inputRange.min_val.height
      || c->dest.dim.h > inputRange.max_val.height)
    /* FIXME: or should we just clamp here? */
    return -EINVAL;
#else
    /* TODO: FIXME Check rescale factors here */
#endif
...
#if DEBUG_VAR == 1
      DPRINTK ("%s: found mode(%d): %u tvStandard: 0x%x stmfbid: 0x%.16llx %s\n",
...
#else
      DPRINTK ("%s: found mode(%d): %u tvStandard: 0x%x stmfbid: 0x%.16llx\n",
               __FUNCTION__, x, stmfbio_standard_list[x].mode,
               stmfbio_standard_list[x].tvStandard, output->standard);
#endif
                                     ...
                                     stm_display_mode_t             * const vm)
{
  ...
  else if(outputStandards == STM_OUTPUT_STD_HDMI_LLC_EXT)
    vm->mode_params.output_standards = STM_OUTPUT_STD_HDMI_LLC_EXT; /* For Ultra High Definition UHD modes */
  else
    BUG();
                           ...
                           struct stmfbio_outputstandards * const stds)
{
  ...
  DPRINTK ("%s: Output capabilities: 0x%x\n", __FUNCTION__, caps);
  ...
  if (caps & OUTPUT_CAPS_UHD_DIGITAL) {
     ...
     */
    if (!stm_display_output_get_display_mode (i->hFBMainOutput,
                                             STM_TIMING_MODE_4K2K30000_297000, &dummy))
    {
      DPRINTK ("%s: adding UHD 4K2K Progressive on HDMI output standards\n", __FUNCTION__);
      stds->all_standards |= STMFBIO_STD_4K2KP;
    }
    else
    {
      if(signal_pending(current))
  ...
  for (x = 0; x < ARRAY_SIZE (stmfbio_standard_list); ++x)
  {
        ...
        && stmfbio_standard_list[x].tvStandard == tvStandard)
    {
      DPRINTK ("%s: found mode(%d): %u tvStandard: 0x%lx stmfbid: 0x%.16llx\n",
               __FUNCTION__, x, vm->mode_id, tvStandard,
...
stmfb_queuebuffer (struct stmfb_info * const i)
{
  ...
  DPRINTK("%s: pa sz: %x/%u, fmt: %d %ubpp pitch/lines: %u/%u\n",
          __FUNCTION__,
                     ...
                     struct stmfb_info                 * const i)
{
  ...
  if(v->caps & STMFBIO_VAR_CAPS_OPACITY)
  {
    ...
    else if (v->activate == STMFBIO_ACTIVATE_ON_NEXT_CHANGE)
    {
      ...
      DPRINTK("ON_NEXT_CHANGE: Opacity = %d.\n",v->opacity);
  ...
  && ( i->current_var_ex.fullscreen != v->fullscreen))
  {
    ...
    if(v->activate == STMFBIO_ACTIVATE_IMMEDIATE)
    {
      ...
      {
        DPRINTK("FAILED: Set plane output window auto = %d.\n",plane_mode);
        v->failed |= STMFBIO_VAR_CAPS_FULLSCREEN;
      }

      if(!(v->failed & STMFBIO_VAR_CAPS_FULLSCREEN))
      {
        DPRINTK("plane output window mode = %d.\n",plane_mode);
        i->current_var_ex.fullscreen = v->fullscreen;
      }
     }
     else
                  ...
                  struct stmfb_info                 * const i)
{
  ...
  else
  {
    ...
    if(v->activate == STMFBIO_ACTIVATE_IMMEDIATE)
    {
      ...
      {
        DPRINTK("Queued buffer, num_outstanding_updates = %d\n", i->num_outstanding_updates);
        /*
                     ...
                     const struct stmfb_info           * const i)
{
  ...
  stm_display_plane_is_feature_applicable(plane, PLANE_FEAT_SRC_COLOR_KEY, &isApplicable);
  if(isApplicable)
  {
  ...
  stm_display_plane_is_feature_applicable(plane, PLANE_FEAT_FLICKER_FILTER, &isApplicable);
  if(isApplicable)
  {
...
/* TODO: FIXME PLANE_CAPS_RESCALE_TO_VIDEO_RANGE need to be matched with new features */
  ...
  stm_display_plane_is_feature_applicable(plane, PLANE_FEAT_TRANSPARENCY, &isApplicable);
  if(isApplicable)
  {
    ...
    DPRINTK("Plane supports alpha ramp\n");
    v->caps |= STMFBIO_VAR_CAPS_ALPHA_RAMP;
    v->alpha_ramp[0] = 0;
    v->alpha_ramp[1] = 255;
  }

  stm_display_plane_is_feature_applicable(plane, PLANE_FEAT_GLOBAL_COLOR, &isApplicable);
  if(isApplicable)
  {
  ...
  stm_display_plane_get_depth(plane, i->hFBMainOutput, &v->z_position);

  stm_display_plane_is_feature_applicable(plane, PLANE_FEAT_WINDOW_MODE, &isApplicable);
  if(isApplicable)
  {
    DPRINTK("Plane has fullscreen mode support\n");
