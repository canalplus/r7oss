...
and modified by STMicroelectronics on 2014-05-14
...
#define STMFBIO_VAR_CAPS_FULLSCREEN     (1L<<13)
...
enum stmfbio_output_standard {
	...
	/* ultra high definition 4K2K display modes (4K UHD) */
	STMFBIO_STD_4K2KP_29_97    = 0x0000000000400000LLU,
	STMFBIO_STD_4K2KP_30       = 0x0000000000800000LLU,
	STMFBIO_STD_4K2KP_25       = 0x0000000001000000LLU,
	STMFBIO_STD_4K2KP_23_98    = 0x0000000002000000LLU,
	STMFBIO_STD_4K2KP_24       = 0x0000000004000000LLU,
	STMFBIO_STD_4K2KP_24_WIDE  = 0x0000000008000000LLU,
	...
	STMFBIO_STD_XGA_70       = 0x2000000000000000LLU,
	STMFBIO_STD_XGA_75       = 0x4000000000000000LLU,
	STMFBIO_STD_XGA_85       = 0x8000000000000000LLU,
};
...
#define STMFBIO_STD_4K2KP     (STMFBIO_STD_4K2KP_29_97       \
                               | STMFBIO_STD_4K2KP_30        \
                               | STMFBIO_STD_4K2KP_25        \
                               | STMFBIO_STD_4K2KP_23_98     \
                               | STMFBIO_STD_4K2KP_24        \
                               | STMFBIO_STD_4K2KP_24_WIDE)
...
struct stmfbio_var_screeninfo_ex2
{
  /*
   * Display layer to operate on, 0 is always the layer showing the framebuffer.
   * No other layers have to be defined and the IOCTL will return ENODEV
  ...
  __u32 z_position;                   /* STMFBIO_VAR_CAPS_ZPOSITION           */
  __u8  fullscreen;                   /* STMFBIO_VAR_CAPS_FULLSCREEN          */
};
...
#define STMFBIO_OUTPUT_DVO_EMBEDDED_SYNC          (1L<<10)
#define STMFBIO_OUTPUT_DVO_INVERT_DATA_CLOCK      (1L<<11)
 ...
 * <include/stm_metadata.h> and should not be changed.
 */
...
#define STMFBIO_GET_VAR_SCREENINFO_EX2  _IOR ('B', 0x12, struct stmfbio_var_screeninfo_ex2)
#define STMFBIO_SET_VAR_SCREENINFO_EX2  _IOWR('B', 0x13, struct stmfbio_var_screeninfo_ex2)
...
#define STMFBIO_SET_CLOSED_CAPTION      _IO  ('B', 0x2f)
#define STMFBIO_SET_WSS_ANALOG          _IO  ('B', 0x3f)
