...
#ifndef _PTI_DBG_LITE_H_
#define _PTI_DBG_LITE_H_
...
int stptiHAL_DebugObjectTreeLite(FullHandle_t RootHandle, char *Buffer, int Limit, int Offset, int *EOF_p);

#endif /* _PTI_DBG_LITE_H_ */
