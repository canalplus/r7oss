...
#ifndef _PTI_CONTAINER_H_
#define _PTI_CONTAINER_H_
...
} stptiHAL_Container_t;

/* Exported Function Prototypes -------------------------------------------- */
extern const stptiHAL_ContainerAPI_t stptiHAL_ContainerAPI;

#define stptiHAL_GetObjectContainer_p(ObjectHandle)   ((stptiHAL_Session_t *)stptiOBJMAN_HandleToObjectPointer(ObjectHandle,OBJECT_TYPE_CONTAINER))

#endif /* _PTI_CONTAINER_H_ */
