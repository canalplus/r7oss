...
//		                debug_log("COCO: dispatch pre watch ready %p %p", wa.get(), wa.get()->data());
		                _mutex_w.unlock();
		                wa->ready(*wa);
		                _mutex_w.lock();
//		                debug_log("COCO: dispatch post watch ready %p %p", wa.get(), wa.get()->data());
