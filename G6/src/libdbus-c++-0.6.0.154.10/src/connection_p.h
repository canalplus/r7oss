...
struct DXXAPILOCAL Connection::Private
{
	...
	Private(DBusConnection *, Server::Private * = NULL, bool priv = true);
	...
	static void on_wakeup(void *data);
	static void pending_cond_notify(DBusPendingCall *, void *);
	static void pending_cond_free(void *);
