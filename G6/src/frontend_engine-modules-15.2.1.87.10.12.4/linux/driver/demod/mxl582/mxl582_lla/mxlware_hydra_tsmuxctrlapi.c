...
static MXL_STATUS_E MxL_HYDRA_CfgTSPadMux(UINT8 devId, MXL_HYDRA_CONTEXT_T * devHandlePtr, MXL_BOOL_E enableSerialTS)
{
  UINT8 mxlStatus = (UINT8)MXL_SUCCESS;
  ...
  switch(devHandlePtr->deviceType)
  {
    ...
    case MXL_HYDRA_DEVICE_544:
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_01_PINMUX_SEL, 0);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_02_PINMUX_SEL, 0);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_03_PINMUX_SEL, 0);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_04_PINMUX_SEL, 0);      
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_08_PINMUX_SEL, 0);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_27_PINMUX_SEL, 1);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_28_PINMUX_SEL, 1);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_29_PINMUX_SEL, 1);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_30_PINMUX_SEL, 1);      
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_32_PINMUX_SEL, 1);
        mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_33_PINMUX_SEL, 1);
        if (enableSerialTS == MXL_ENABLE)
        {
          
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_09_PINMUX_SEL, 0);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_10_PINMUX_SEL, 0);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_11_PINMUX_SEL, 0);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_12_PINMUX_SEL, 0);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_13_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_14_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_15_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_16_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_17_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_18_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_19_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_20_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_21_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_22_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_23_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_24_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_25_PINMUX_SEL, 2);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_26_PINMUX_SEL, 2);      
        }
        else 
        // parallel mode
        {
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_09_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_10_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_11_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_12_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_13_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_14_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_15_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_16_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_17_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_18_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_19_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_20_PINMUX_SEL, 3);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_21_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_22_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_23_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_24_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_25_PINMUX_SEL, 1);
          mxlStatus |= SET_REG_FIELD_DATA(devId, PAD_MUX_DIGIO_26_PINMUX_SEL, 1);         
        }
      break;
  ...
  if ((mxlStatus == MXL_SUCCESS) && (mpegOutParamPtr))
  {
    ...
    if (MXL_ENABLE == mpegOutParamPtr->enable)
    {
      ...
      if (mpegOutParamPtr->mpegMode == MXL_HYDRA_MPEG_MODE_PARALLEL)
      {
        ...
        mxlStatus |= MxL_HYDRA_CfgTSPadMux(devId, devHandlePtr, MXL_FALSE);
      ...
      else
      {
        ...
        mxlStatus |= MxL_HYDRA_CfgTSPadMux(devId, devHandlePtr, MXL_TRUE);
...
static MXL_STATUS_E MxL_HYDRA_CfgUpdatePidFilterTable(UINT8 devId, MXL_HYDRA_CONTEXT_T * devHandlePtr, MXL_HYDRA_DEMOD_ID_E demodId, MXL_BOOL_E updateDirtyFlag)
{
  ...
  {
    mappedSharedFiltId = (MXL_HYDRA_DEMOD_ID_E)MxL_Ctrl_GetTsID(devHandlePtr, (MXL_HYDRA_DEMOD_ID_E)sharedFiltId);
...
MXL_STATUS_E MxLWare_SCR_API_CfgTSPidFilterCtrl(UINT8 devId)
{
  ...
  mxlStatus |= MxLWare_HYDRA_ReadRegister(devId, 0x90700270, &regData);
    
  regData = 0x91919191;

  mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, 0x90700270, regData);
  mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, 0x90700274, regData);

  // 4:1 mux
  mxlStatus |= MxLWare_HYDRA_ReadRegister(devId, 0x90700008, &regData);
  regData = regData & ~0x3;
  regData |= 0x3;
  mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, 0x90700008, regData);
...
#define CB_PID_FILTER_START_ADDR    0x90708000
UINT32 BondId_pid_Entry[2] = {CB_PID_FILTER_START_ADDR, CB_PID_FILTER_START_ADDR + 0x400 };
...
MXL_STATUS_E MxLWare_SCR_API_CfgPidFilterTbl(UINT8 devId, UINT32 idx, MXL_SCR_PID_T pidCfg)
{
  ...
  MXLENTERAPISTR(devId);
  MXLENTERAPI(MXL_HYDRA_PRINT("Idx = %d, bondId = %d, pid = %d \n", idx, pidCfg.bondId, pidCfg.pid););

  mxlStatus = MxLWare_HYDRA_Ctrl_GetDeviceContext(devId, &devHandlePtr);

  if ((mxlStatus == MXL_SUCCESS) && (idx < 32) && (pidCfg.destId < 8))
  {
    data_0 = REGULAR_PID_DATA_0(pidCfg.valid,pidCfg.allow,0,pidCfg.pid,0x1FFF);

    if (pidCfg.serOrPar) data_1 = REGULAR_PID_DATA_1(0,0);
    else  data_1 = REGULAR_PID_DATA_1(0,pidCfg.portId);

    data_1 |= (pidCfg.serOrPar << 31);
    data_1 |= (1 << (23 + pidCfg.destId));
    data_1 |= ((pidCfg.bondId & 0x3) << 19);

    mxlStatus |= MxLWare_HYDRA_ReadRegister(devId, 0x90700190, &pidFiltCtx);
    pidFiltCtx = pidFiltCtx & ~0x03;
    mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, 0x90700190, pidFiltCtx);

    mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, (BondId_pid_Entry[pidCfg.bondId] + (idx * 8)), data_0);
    mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, (BondId_pid_Entry[pidCfg.bondId] + ((idx * 8) + 4)), data_1);
...
MXL_STATUS_E MxLWare_SCR_API_ClearPidFilter(UINT8 devId, UINT32 bondId)
{
  ...
  MXLENTERAPISTR(devId);
  MXLENTERAPI(MXL_HYDRA_PRINT("bondId = %d \n", bondId););

  mxlStatus = MxLWare_HYDRA_Ctrl_GetDeviceContext(devId, &devHandlePtr);

  if ((mxlStatus == MXL_SUCCESS) && (bondId < 2))
  {
    for (idx = 0; idx < 32; idx++)
    {
      ...
      mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, (BondId_pid_Entry[bondId] + (idx * 8)), 0);
      mxlStatus |= MxLWare_HYDRA_WriteRegister(devId, (BondId_pid_Entry[bondId] + ((idx * 8) + 4)), 0);
