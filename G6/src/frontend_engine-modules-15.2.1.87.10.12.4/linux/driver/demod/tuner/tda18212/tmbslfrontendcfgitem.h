...
/******************************************************************************/
/** \brief "This enum are used to choose a configuration item in set/get config
 * bsl"
 *
...
typedef enum {
	...
	/* MSBLSB), configure in serial mode if  MSB or LSB first */
	TMBSLFRONTEND_CFG_ITEM_MAKE(Out1SLSB),
	/* Transport stream mode A), B), C... */
	TMBSLFRONTEND_CFG_ITEM_MAKE(Out1TSMode),
	...
	/* Control GPIO1 in open-drain for Vestel application */
	TMBSLFRONTEND_CFG_ITEM_MAKE(SetAntennaPower) = 600,
