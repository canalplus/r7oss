...
#define ddTDA182I2_ERR_NOT_READY (ddTDA182I2_ERR_BASE + TM_ERR_INIT_FAILED)
#define ddTDA182I2_ERR_BAD_VERSION (ddTDA182I2_ERR_BASE + TM_ERR_COMP_VERSION)
...
tmErrorCode_t tmddTDA182I2GetIdentity(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned short *puValue/* I: Address of the var to output item value*/);
...
tmErrorCode_t tmddTDA182I2GetIF_Freq(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned int *puValue/*I: Address of the var to output item value*/);
...
tmErrorCode_t tmddTDA182I2GetRFCAL_Offset0(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2SetRFCAL_Offset1(tmUnitSelect_t tUnit,/*I:Unit#*/
					   UInt8 uValue	/* I: Item value */);
...
tmErrorCode_t tmddTDA182I2GetIRQ_Polarity(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_0(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_1(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_2(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_3(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_4(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_5(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_6(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_7(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_8(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_9(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_10(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
tmErrorCode_t tmddTDA182I2Getrfcal_log_11(tmUnitSelect_t tUnit,/*I:Unit#*/
	unsigned char *puValue/* I: Address of the var to output item value*/);
