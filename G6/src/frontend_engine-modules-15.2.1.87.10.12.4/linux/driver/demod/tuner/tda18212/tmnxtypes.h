...
#define False           0
#define True            1
#define TMFL_OS_IS_ECOS 0	/*added to remove warnings by ms */
#define TMFL_OS_IS_PSOS 0	/*added to remove warnings by ms */
#define TMFL_OS_IS_HPUNIX 0	/*added to remove warnings by ms */
#define TMFL_OS_IS_NULLOS 0	/*added to remove warnings by ms */
...
typedef unsigned int CUInt32;	/* 32 bit unsigned integer */
...
/* #define inline __inline__  *//*commented to remove warning in linux */
...
#ifdef __GNUC__
#define DEPRECATED(_LEGACYFUNC, _FUNC) (_LEGACYFUNC __attribute__ ( \
			(deprecated("was declared deprecated. Use " \
			## #_FUNC ## " instead."))))
#define DEPRECATED_MSG(_LEGACY, _NEW)
#elif defined(_MSC_VER)
#define DEPRECATED(_LEGACYFUNC, _FUNC) (__declspec(deprecated( \
				"was declared deprecated. Use " \
				## #_FUNC ## " instead.")) _LEGACYFUNC)
#define DEPRECATED_MSG(_LEGACY, _NEW) (__pragma(message( \
				__FILE__ "(0) : warning C4996: " \
				_LEGACY " was declared deprecated. Use " \
				_NEW " instead.")))
#else
