...
#define CID_GET_CLASS(compId) ((compId & CID_CLASS_BITMASK) >> \
							CID_CLASS_BITSHIFT)
...
#define CID_GET_LAYER(compId) ((compId & CID_LAYER_BITMASK) >> \
							CID_LAYER_BITSHIFT)
...
/* Stop of a single pin is in progress (obsolescent) */
#define TM_ERR_STOP_PIN_REQUESTED       0x048
/* Stop of a single pin is in progress */
#define TM_ERR_PAUSE_PIN_REQUESTED      0x048
