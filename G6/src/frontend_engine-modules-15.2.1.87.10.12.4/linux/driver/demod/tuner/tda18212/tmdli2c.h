...
#define I2C_ERR_COMP (CID_COMP_PARPORT | CID_LAYER_HWAPI | \
...
typedef tmErrorCode_t(*w_tmdlI2CCallBack) (tmUnitSelect_t tUnit,
		CUInt32 uHwAddress, CUInt32 addrSize,
		CUInt8 * pAddr, CUInt32 dataSize,
		CUInt8 * pData, tmErrorCode_t err,
		tmI2CAction_t i2cAction,
...
/*  O: Receives SW Version  */
extern tmErrorCode_t tmdlI2CGetSWVersion(ptmSWVersion_t pSWVersion);

extern tmErrorCode_t tmdlI2CGetLowLevelSWVersion(tmUnitSelect_t tUnit,
		ptmSWVersion_t pSWVersion,	/*  O: Receives SW Version  */
		ptmI2CLLDriverVersion pLLSWVersion/*O:Receives LL SW Version*/);

extern tmErrorCode_t tmdlI2CGetLowLevelDevices(tmUnitSelect_t tUnit,
		ptmI2CEnumDevices pDevices	/*  O: Receives LL Devices */);

extern tmErrorCode_t tmdlI2CInit(tmUnitSelect_t tUnit,	/* I: FrontEnd unit #*/
		tmbslFrontEndDependency_t *psSrvFunc);

extern tmErrorCode_t tmdlI2CDeInit(tmUnitSelect_t tUnit);

extern tmErrorCode_t tmdlI2CSetInterface(tmUnitSelect_t tUnit,
		ptmI2CInterfaceConfig_t psI2CInterface);

extern tmErrorCode_t
tmdlI2CSetPath(tmUnitSelect_t tUnit, int pPath_length, wchar_t *My_path);

extern tmErrorCode_t tmdlI2CGetInterface(tmUnitSelect_t tUnit,
		ptmI2CInterfaceConfig_t psI2CInterface);

extern tmErrorCode_t
tmdlI2CSetGPIO(tmUnitSelect_t tUnit, UInt8 Port, UInt8 Mask, UInt8 Value);

extern tmErrorCode_t tmdlI2CWrite(tmUnitSelect_t tUnit, UInt32 uHwAddress,
		UInt32 AddrSize, UInt8 *pAddr, UInt32 WriteLen, UInt8 *pData);

extern tmErrorCode_t tmdlI2CRead(tmUnitSelect_t tUnit, UInt32 uHwAddress,
		UInt32 AddrSize, UInt8 *pAddr, UInt32 ReadLen, UInt8 *pData);

extern tmErrorCode_t
tmdlI2CSetErrorEnable(tmUnitSelect_t tUnit, Bool bErrorEnable);

extern tmErrorCode_t
tmdlI2CGetErrorEnable(tmUnitSelect_t tUnit, Bool *pbErrorEnable);

extern tmErrorCode_t
tmdlI2CSetPortType(tmUnitSelect_t tUnit, tmI2CPortType_t dwPortType);

extern tmErrorCode_t
tmdlI2CGetPortType(tmUnitSelect_t tUnit, ptmI2CPortType_t pdwPortType);

extern tmErrorCode_t tmdlI2CSetBitrate(tmUnitSelect_t tUnit, UInt32 dwBitrate);

extern tmErrorCode_t
tmdlI2CGetBitrate(tmUnitSelect_t tUnit, UInt32 *pdwBitrate);

extern tmErrorCode_t
tmdlI2CSetHwAddrAsWriteAddr(tmUnitSelect_t tUnit, Bool bHwAddrAsWriteAddr);

extern tmErrorCode_t tmdlI2CGetHwAddrAsWriteAddr(tmUnitSelect_t tUnit,
		Bool *pbHwAddrAsWriteAddr);

extern tmErrorCode_t tmdlSpiWrite(tmUnitSelect_t tUnit, tmSpiChipSelect_t eCS,
		UInt32 DataLenthInBits, UInt8 *pData);

extern tmErrorCode_t tmdlSpiRead(tmUnitSelect_t tUnit, tmSpiChipSelect_t eCS,
		UInt32 DataLenthInBits, UInt8 *pData);
