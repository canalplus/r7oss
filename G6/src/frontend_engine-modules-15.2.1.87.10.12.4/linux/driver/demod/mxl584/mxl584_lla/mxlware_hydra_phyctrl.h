...
#define GET_REG_FIELD_DATA(fieldName, dataPtr) MxLWare_Hydra_ReadByMnemonic(devId, fieldName, dataPtr);
#define SET_REG_FIELD_DATA(fieldName, data) MxLWare_Hydra_UpdateByMnemonic(devId, fieldName, data);
...
void MxLWare_HYDRA_ExtractFromMnemonic(UINT32 regAddr, UINT8 lsbPos, UINT8 width, /*@null@*/ UINT32 * toAddr, /*@null@*/ UINT8 * toLsbPos, /*@null@*/ UINT8 * toWidth);
