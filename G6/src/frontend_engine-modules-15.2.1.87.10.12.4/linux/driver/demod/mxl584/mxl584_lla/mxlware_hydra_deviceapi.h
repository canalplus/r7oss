...
// DiSEqC INTR's
#define MXL_HYDRA_INTR_DISEQC_0                 (1 << 3)
#define MXL_HYDRA_INTR_DISEQC_1                 (1 << 2)
#define MXL_HYDRA_INTR_DISEQC_2                 (1 << 1)
#define MXL_HYDRA_INTR_DISEQC_3                 (1 << 0)
...
typedef struct
{
  ...
  UINT8  numPids;            // Number of PIDs available in the above table
