...
#define REGULAR_PID_DATA_1(remapPid,portId) ( (0x00000000 | (UINT32)remapPid) |  (0x00000000 | (UINT32)((portId & 0x1FFF) << 16)))
...
MXL_STATUS_E MxLWare_HYDRA_API_CfgTsMuxRemapBcastPid(UINT8 devId, MXL_HYDRA_DEMOD_ID_E demodId,
                                                     MXL_HYDRA_TS_PID_T * pidRemapPtr, UINT8 numRemapPids);
...
MXL_STATUS_E MxLWare_HYDRA_API_ReqCurrEntriesPidRemapTbl(UINT8 devId, MXL_HYDRA_DEMOD_ID_E demodId, MXL_HYDRA_TS_PID_T *remapPidPtr, UINT8 *numEntriesPtr);
