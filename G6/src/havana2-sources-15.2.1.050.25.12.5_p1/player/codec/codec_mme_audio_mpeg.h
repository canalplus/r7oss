...
public:
    ...
    static void GetCapabilities(stm_se_audio_dec_capability_t::audio_dec_mp2a_capability_s *cap,
                                const MME_LxAudioDecoderHDInfo_t decInfo);
    static void GetCapabilities(stm_se_audio_dec_capability_t::audio_dec_mp3_capability_s *cap,
                                const MME_LxAudioDecoderHDInfo_t decInfo);
    //
