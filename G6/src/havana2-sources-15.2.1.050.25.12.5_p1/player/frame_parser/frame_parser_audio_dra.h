...
#ifndef H_FRAME_PARSER_AUDIO_DRA
#define H_FRAME_PARSER_AUDIO_DRA
...
class FrameParser_AudioDra_c : public FrameParser_Audio_c
{
public:
    FrameParser_AudioDra_c(void);
    ~FrameParser_AudioDra_c(void);
    ...
    static FrameParserStatus_t ParseFrameHeader(unsigned char *FrameHeader, DraAudioParsedFrameHeader_t *ParsedFrameHeader);
...
private:
    ...
    DraAudioStreamParameters_t  *StreamParameters;
    DraAudioStreamParameters_t   CurrentStreamParameters;
    DraAudioFrameParameters_t   *FrameParameters;

    DISALLOW_COPY_AND_ASSIGN(FrameParser_AudioDra_c);
};

#endif /* H_FRAME_PARSER_AUDIO_DRA */
