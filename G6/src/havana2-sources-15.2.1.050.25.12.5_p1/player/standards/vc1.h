...
// SMPTE RP227
// 4.2.6 Stream ID Extension (PES)
// For VC-1 Elementary Streams, the stream_id_extension field defined in ISO 13818-1, Amendment 2 shall have any
// value in the range between 0x55 and 0x5F. These values are defined within the allowed private range in ISO 13818-1, Amendment 2
#define VC1_STREAM_ID_EXTENTION_START                    0x55
#define VC1_STREAM_ID_EXTENTION_STOP                     0x5F
...
/* We are ignoring User defined start code suffixes, starting from Slice Level User Data (0x1B) to Sequence
   Level User Data (0x1F) (reference from Final Draft Standard 421M: VC-1) */
#define VC1_SLICE_LEVEL_USER_DATA                       0x1B
#define VC1_SEQUENCE_LEVEL_USER_DATA                    0x1F
