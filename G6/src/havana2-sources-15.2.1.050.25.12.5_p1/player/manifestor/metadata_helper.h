...
class BaseMetadataHelper_c
{
public:
    BaseMetadataHelper_c(void) {}
    ~BaseMetadataHelper_c(void) {}

    void setVideoUncompressedMetadata(DecodeBufferComponentType_t ManifestationComponent,
                                      ...
                                      bool UseWindowOfInterest = false);
