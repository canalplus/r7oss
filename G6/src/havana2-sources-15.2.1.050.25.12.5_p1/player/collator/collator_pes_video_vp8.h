...
#ifndef H_COLLATOR_PES_VIDEO_VP8
#define H_COLLATOR_PES_VIDEO_VP8

#include "collator_pes_frame.h"

#undef  TRACE_TAG
#define TRACE_TAG "Collator_PesVideoVp8_c"

/*
The On2 VP8 collator is very similar to the wmv collator because On2 VP8 streams
...
class Collator_PesVideoVp8_c : public Collator_PesFrame_c
{
public:
    Collator_PesVideoVp8_c(void)
    {
...
#endif /* H_COLLATOR_PES_VIDEO_VP8 */
