...
//Fixed Codec Params
#define TEST_ENCODING_CODEC                        STM_SE_ENCODE_STREAM_ENCODING_AUDIO_MP3
#define TEST_SAMPLES_PER_ES_FRAME                  1152
#define TEST_CODEC_INTERNAL_DELAY_FRAME            3
...
static int StaticTest017(EncoderTestArg *arg)
{
    ...
    if (result < 0)
    {
        pr_err("Error: %s Failed to create a new STM_SE_ENCODE_STREAM_ENCODING_AUDIO_MP3 EncodeStream\n", __func__);
...
ENCODER_TEST(StaticTest017, "Test MP3E Encoding test", BASIC_TEST);
