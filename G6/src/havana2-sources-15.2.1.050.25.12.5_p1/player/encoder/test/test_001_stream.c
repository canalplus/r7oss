...
int stream_test(EncoderTestArg *arg)
{
    ...
    //- so its important we distinctly remove our streams ourselves
...
ENCODER_TEST(stream_test, "Stream Object create and delete", BASIC_TEST);
