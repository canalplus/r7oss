...
************************************************************************/
#ifndef PREPROC_AUDIO_NULL_H
#define PREPROC_AUDIO_NULL_H

#include "preproc_audio.h"

class Preproc_Audio_Null_c : public Preproc_Audio_c
{
public:
    Preproc_Audio_Null_c(void);
    ~Preproc_Audio_Null_c(void);
