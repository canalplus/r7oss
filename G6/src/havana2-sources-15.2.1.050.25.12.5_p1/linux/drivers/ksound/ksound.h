...
#else
static inline int ksnd_pcm_open(ksnd_pcm_t **handle, int card, int device,
                                snd_pcm_stream_t stream)
{
	return -ENODEV;
}
static inline void ksnd_pcm_close(ksnd_pcm_t *handle) { }
#endif
...
#else
static inline int ksnd_pcm_start(ksnd_pcm_t *substream)
{
	return -ENODEV;
}
/* TODO: ksnd_pcm_stop not found in alsalib */
static inline int ksnd_pcm_stop(ksnd_pcm_t *handle)
{
	return -ENODEV;
}
#endif
...
#else
static inline int ksnd_pcm_prepare(ksnd_pcm_t *substream)
{
	return -ENODEV;
}
#endif
...
#else
static inline int ksnd_pcm_mtimestamp(ksnd_pcm_t *pcm, snd_pcm_uframes_t *avail,
                                      struct timespec *mstamp)
{
	return -ENODEV;
}
static inline snd_pcm_uframes_t ksnd_pcm_avail_update(ksnd_pcm_t *substream)
{
	return NULL;
}
static inline int ksnd_pcm_wait(ksnd_pcm_t *pcm, int timeout)
{
	return -ENODEV;
}
#endif
...
#else
static inline int ksnd_pcm_mmap_begin(ksnd_pcm_t *pcm,
                                      const snd_pcm_channel_area_t **areas,
                                      snd_pcm_uframes_t *offset, snd_pcm_uframes_t *frames)
{
	return -ENODEV;
}
static inline snd_pcm_sframes_t ksnd_pcm_mmap_commit(ksnd_pcm_t *pcm,
                                                     snd_pcm_uframes_t offset,
                                                     snd_pcm_uframes_t frames)
{
	return NULL;
...
#else
static inline int ksnd_pcm_set_params(ksnd_pcm_t *handle,
                                      int nrchannels, int sampledepth, int samplerate,
                                      int periodsize, int buffersize)
{
	return -ENODEV;
}
static inline int ksnd_pcm_get_params(ksnd_pcm_t *kpcm,
                                      snd_pcm_uframes_t *buffer_size,
                                      snd_pcm_uframes_t *period_size)
{
	return -ENODEV;
...
#else
static inline void ksnd_ctl_elem_id_set_interface(struct snd_ctl_elem_id *obj, snd_ctl_elem_iface_t val) { }
static inline void ksnd_ctl_elem_id_set_name(struct snd_ctl_elem_id *obj, const char *val) { }
static inline void ksnd_ctl_elem_id_set_device(struct snd_ctl_elem_id *obj, unsigned int val) { }
static inline void ksnd_ctl_elem_id_set_index(struct snd_ctl_elem_id *obj, unsigned int val) { }
static inline struct snd_kcontrol *ksnd_substream_find_elem(struct snd_pcm_substream *substream,
                                                            struct snd_ctl_elem_id *id)
{
	return NULL;
}
...
#else
static inline void ksnd_ctl_elem_value_set_id(struct snd_ctl_elem_value *obj, const struct snd_ctl_elem_id *ptr) { }
static inline void ksnd_ctl_elem_value_set_integer(struct snd_ctl_elem_value *obj, unsigned int idx, long val) { }
static inline void ksnd_ctl_elem_value_set_iec958(struct snd_ctl_elem_value *obj, const struct snd_aes_iec958 *ptr) { }
static inline int ksnd_hctl_elem_write(struct snd_kcontrol *elem, struct snd_ctl_elem_value *control)
{
	return 0;
}
#endif
