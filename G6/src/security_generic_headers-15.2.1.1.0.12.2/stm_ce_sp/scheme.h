...
Source file name : scheme.h

Defines the scheme profile, used to determine the firmware to be loaded
************************************************************************/

#ifndef __STM_CE_SCHEME
#define __STM_CE_SCHEME

#define STM_CE_SESSION_DEFAULT_SCHEME "default"

#endif /* __STM_CE_SCHEME */
