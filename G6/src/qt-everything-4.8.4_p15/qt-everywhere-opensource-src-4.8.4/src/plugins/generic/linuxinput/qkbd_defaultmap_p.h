...
#ifndef QKEYBOARDHANDLER_DEFAULTMAP_H
#define QKEYBOARDHANDLER_DEFAULTMAP_H
...
const QLinuxInputKeyboardMap::Mapping QLinuxInputKeycodeHandlerPrivate::s_keymap_default[] = {
...
const QLinuxInputKeyboardMap::Composing QLinuxInputKeycodeHandlerPrivate::s_keycompose_default[] = {
