...
//#include <../../../widgets/kernel/qapplication.h>
...
class QLinuxInputKeycodeHandlerPrivate;

class  Q_GUI_EXPORT QLinuxInputKeycodeHandler
{
public:
    QLinuxInputKeycodeHandler();
    QLinuxInputKeycodeHandler(const QString &device);
    virtual ~QLinuxInputKeycodeHandler();
...
private:
    QLinuxInputKeycodeHandlerPrivate *d;
};

#endif // QT_NO_QKEYBOARD
