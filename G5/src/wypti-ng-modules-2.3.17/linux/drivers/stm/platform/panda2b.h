...
static struct platform_device *board_panda2b[] __initdata = {
	&tsm_device,
    &pti1_device,
    &pti2_device,
};
...
{
    return platform_add_devices(board_panda2b,
                                sizeof(board_panda2b) / sizeof(struct platform_device*));
}

#endif /* CONFIG_SH_PANDA2B */
