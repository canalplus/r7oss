...
bool QDirectFBScreen::trackDFBSurface(IDirectFBSurface* p_pDFBSurfaceToTrack)
{
    if (p_pDFBSurfaceToTrack == NULL)
    {
        qWarning("QDirectFBScreen::trackDFBSurface()  : (p_pDFBSurfaceToTrack == NULL) !\n");
        return false;
    }

    p_pDFBSurfaceToTrack->AddRef(p_pDFBSurfaceToTrack);
    d_ptr->allocatedSurfaces.insert(p_pDFBSurfaceToTrack);
