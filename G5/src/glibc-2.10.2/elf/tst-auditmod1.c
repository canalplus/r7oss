...
# define pltenter la_st200_gnu_pltenter
# define pltexit  la_st200_gnu_pltexit
# define La_regs La_st200_regs
# define La_retval La_st200_retval
# define int_retval lrv_r16
#endif
