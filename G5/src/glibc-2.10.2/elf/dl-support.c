...
const char *_dl_base_platform;
size_t _dl_base_platformlen;
...
_dl_non_dynamic_init (void)
{
  ...
  /* Now determine the length of the base platform string.  */
  if (_dl_base_platform != NULL)
    _dl_base_platformlen = strlen (_dl_base_platform);
