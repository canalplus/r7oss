...
{
	static int __initdata ints[NR_CPUS], i;
...
* TIF_KERNEL_TRACE flag. Setting the TIF_KERNEL_TRACE flag with the
* tasklist_lock held in copy_process() makes sure that once we finish
* setting the thread flags, all threads have their flags set.
*/
