...
static inline void dma_cache_wback_inv(void *start, int size)
{
	__flush_purge_region(start, size);
	stm_l2_flush_purge_region(start, size);
}

static inline void dma_cache_inv(void *start, int size)
{
	__flush_invalidate_region(start, size);
	stm_l2_flush_invalidate_region(start, size);
}

static inline void dma_cache_wback(void *start, int size)
{
