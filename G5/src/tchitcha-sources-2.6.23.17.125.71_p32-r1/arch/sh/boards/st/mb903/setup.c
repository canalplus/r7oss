/*
 * arch/sh/boards/st/mb903/setup.c
 *
...
#define MB903_GPIO_GMII0_NOTRESET stpio_to_gpio(20, 0)
#define MB903_GPIO_GMII1_NOTRESET stpio_to_gpio(15, 4)
#define MB903_GPIO_GMII1_PHY_CLKOUTNOTTX_CLK_SEL stpio_to_gpio(19, 1)

/* All the power-related PIOs are pulled up, so "ON" by default,
 * there is no need to touch them unless one really wants to... */
#define MB903_GPIO_POWER_ON_5V stpio_to_gpio(21, 7)
#define MB903_GPIO_POWER_ON_1V5LMI stpio_to_gpio(22, 0)
#define MB903_GPIO_POWER_ON_SATA stpio_to_gpio(22, 2)
#define MB903_GPIO_POWER_ON_SHUTDOWN stpio_to_gpio(22, 3)
...
{
	gpio_set_value(MB903_GPIO_GMII0_NOTRESET, 0);
	udelay(10000); /* 10 miliseconds is enough for everyone ;-) */
	gpio_set_value(MB903_GPIO_GMII0_NOTRESET, 1);
...
{
	gpio_set_value(MB903_GPIO_GMII1_NOTRESET, 0);
	udelay(10000); /* 10 miliseconds is enough for everyone ;-) */
	gpio_set_value(MB903_GPIO_GMII1_NOTRESET, 1);
...
{
	gpio_set_value(MB903_GPIO_GMII1_PHY_CLKOUTNOTTX_CLK_SEL,
...
{
	gpio_request(MB903_GPIO_GMII0_NOTRESET, "GMII0_notRESET");
	gpio_direction_output(MB903_GPIO_GMII0_NOTRESET, 0);

	gpio_request(MB903_GPIO_GMII1_NOTRESET, "GMII1_notRESET");
	gpio_direction_output(MB903_GPIO_GMII1_NOTRESET, 0);

	gpio_request(MB903_GPIO_GMII1_PHY_CLKOUTNOTTX_CLK_SEL,
			"GMII1_PHY_CLKOUTnotTX_CLK_SEL");
	gpio_direction_output(MB903_GPIO_GMII1_PHY_CLKOUTNOTTX_CLK_SEL, 1);
