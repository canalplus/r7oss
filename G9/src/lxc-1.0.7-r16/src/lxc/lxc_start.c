...
static int my_parser(struct lxc_arguments* args, int c, char* arg)
{
    ...
    case 'k': args->keep_shared_mounts = 1; break;
	}
	return 0;
}
...
static const struct option my_longopts[] = {
    ...
    {"keep-shared-mounts", no_argument, 0, 'k'},
	LXC_COMMON_OPTIONS
};
...
Options :\n\
  ...
  -k, --keep-shared-mounts Do not remount/unmount shared mount points\n\
",
	.options   = my_longopts,
	.parser    = my_parser,
	.checker   = NULL,
...
int main(int argc, char *argv[])
{
    ...
    conf->keep_shared_mounts = (my_args.keep_shared_mounts ? 1 : 0);
