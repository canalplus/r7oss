 ...
 ***************************************************************************/
#define BCHP_BSPI_RAF_START_ADDR                 0x204a3300 /* Physical Starting Address Location in Flash device */
#define BCHP_BSPI_RAF_NUM_WORDS                  0x204a3304 /* Number of Words to be fetched */
#define BCHP_BSPI_RAF_CTRL                       0x204a3308 /* RAF Session Control Register */
#define BCHP_BSPI_RAF_FULLNESS                   0x204a330c /* Fullness indicator for the read ahead buffer */
#define BCHP_BSPI_RAF_WATERMARK                  0x204a3310 /* Watermark level in the read ahead buffer that triggers an interrupt */
#define BCHP_BSPI_RAF_STATUS                     0x204a3314 /* Linear Read Status Register */
#define BCHP_BSPI_RAF_READ_DATA                  0x204a3318 /* Read data from Raf-buffer */
#define BCHP_BSPI_RAF_WORD_CNT                   0x204a331c /* Current number of words fetched from Flash */
#define BCHP_BSPI_RAF_CURR_ADDR                  0x204a3320 /* Current read address for the linear read session */
