 ...
 *
 *
 * Date:           Generated on              Wed Jul 16 11:41:53 2014
 ...
 ***************************************************************************/
#define BCHP_HIF_SPI_INTR2_CPU_STATUS            0x003e1a00 /* CPU interrupt Status Register */
#define BCHP_HIF_SPI_INTR2_CPU_SET               0x003e1a04 /* CPU interrupt Set Register */
#define BCHP_HIF_SPI_INTR2_CPU_CLEAR             0x003e1a08 /* CPU interrupt Clear Register */
#define BCHP_HIF_SPI_INTR2_CPU_MASK_STATUS       0x003e1a0c /* CPU interrupt Mask Status Register */
#define BCHP_HIF_SPI_INTR2_CPU_MASK_SET          0x003e1a10 /* CPU interrupt Mask Set Register */
#define BCHP_HIF_SPI_INTR2_CPU_MASK_CLEAR        0x003e1a14 /* CPU interrupt Mask Clear Register */
#define BCHP_HIF_SPI_INTR2_PCI_STATUS            0x003e1a18 /* PCI interrupt Status Register */
#define BCHP_HIF_SPI_INTR2_PCI_SET               0x003e1a1c /* PCI interrupt Set Register */
#define BCHP_HIF_SPI_INTR2_PCI_CLEAR             0x003e1a20 /* PCI interrupt Clear Register */
#define BCHP_HIF_SPI_INTR2_PCI_MASK_STATUS       0x003e1a24 /* PCI interrupt Mask Status Register */
#define BCHP_HIF_SPI_INTR2_PCI_MASK_SET          0x003e1a28 /* PCI interrupt Mask Set Register */
#define BCHP_HIF_SPI_INTR2_PCI_MASK_CLEAR        0x003e1a2c /* PCI interrupt Mask Clear Register */
