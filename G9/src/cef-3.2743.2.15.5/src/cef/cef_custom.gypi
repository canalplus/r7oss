# This is an example configuration to build CEF for ARM using Ozone/EGL/Nexus
# as the rendering engine. Optimized for Cortex A15 with neon enabled.

{
  'variables': {
    ...
    'ozone_platform_eglhaisi_nexus_zorder' : 53,
